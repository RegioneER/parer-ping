...
### Bugfix: 1
- [#41116](https://parermine.regione.emilia-romagna.it/issues/41116) STRUMENTI URBANISTICI: mancanza icone modifica e cestino in interfaccia PING

### Novità: 3
- [#41085](https://parermine.regione.emilia-romagna.it/issues/41085) Modifica a PING per gestire il numero di oggetti da mandare in trasformazione
- [#40936](https://parermine.regione.emilia-romagna.it/issues/40936) Introduzione della cartella STAGING per il deposito di materiale da elaborare con le trasformazioni
- [#40708](https://parermine.regione.emilia-romagna.it/issues/40708) Introdurre il nuovo framework con la modifica per l'accesso tramite CIE/SPID
...
### Bugfix: 5
- [#40863](https://parermine.regione.emilia-romagna.it/issues/40863) Gestione errori scarico  RdV di Strumenti Urbanistici
- [#40860](https://parermine.regione.emilia-romagna.it/issues/40860) Correzione alla gestione dei campi dell'ufficio urbanistica
- [#40840](https://parermine.regione.emilia-romagna.it/issues/40840) Correzione caricamento dettaglio da action Amministrazione in modifica dettaglio
- [#40835](https://parermine.regione.emilia-romagna.it/issues/40835) Correzione al cruscotto strumenti urbanistici, non funziona il filtro per stato COMPLETATO
- [#40699](https://parermine.regione.emilia-romagna.it/issues/40699) Correzione dell'anomalia dei tempi di apertura del dettaglio oggetto

### Novità: 1
- [#40788](https://parermine.regione.emilia-romagna.it/issues/40788) Ottimizzazione gestione recupero oggetti S3 di grandi dimensioni

## 9.2.0 (04-06-2026)

### Bugfix: 2
- [#40367](https://parermine.regione.emilia-romagna.it/issues/40367) Correzione dell'anno delle altre fasi di elaborazione nell'xml versato
- [#40209](https://parermine.regione.emilia-romagna.it/issues/40209) Correzione della gestione della cronologia in SISMA e SU

### Novità: 9
- [#40597](https://parermine.regione.emilia-romagna.it/issues/40597) Rimozione della gestione delle altre fasi di elaborazione per l'ufficio urbanistica
- [#40458](https://parermine.regione.emilia-romagna.it/issues/40458) Patch di sicurezza per interventi legati a CVE
- [#40412](https://parermine.regione.emilia-romagna.it/issues/40412) Modifica a Ping-xml per aggiunta campo descrizione in invio SU.
- [#40377](https://parermine.regione.emilia-romagna.it/issues/40377) Modifiche alla gestione dei campi dell'urbanistica
- [#40376](https://parermine.regione.emilia-romagna.it/issues/40376) Modifica alla gestione delle altre fasi di elaborazione per gli enti
- [#40375](https://parermine.regione.emilia-romagna.it/issues/40375) Modifiche agli strumenti urbanistici per la gestione del campo descrizione
- [#40357](https://parermine.regione.emilia-romagna.it/issues/40357) Miglioramento usabilità della pagina Gestione parametri 
- [#40309](https://parermine.regione.emilia-romagna.it/issues/40309) Aumento del transaction timeout per MDB di Producer Coda Vers
- [#40295](https://parermine.regione.emilia-romagna.it/issues/40295) Gestione dell'editing nel dettaglio progetto dell'agenzia

## 9.1.0 (07-04-2026)

### Bugfix: 4
- [#40310](https://parermine.regione.emilia-romagna.it/issues/40310) Non è possibile collegare fasi che hanno superato lo stato VERSATO
- [#40297](https://parermine.regione.emilia-romagna.it/issues/40297) Correzione alla compilazione della data BURERT per l'ufficio urbanistico
- [#40257](https://parermine.regione.emilia-romagna.it/issues/40257) correzione della gestione di un oggetto in chiuso_err_vers dopo lo stato chiuso_err_recuperabile
- [#40202](https://parermine.regione.emilia-romagna.it/issues/40202) Correzione dell'errore nell'aggiornamento del file xsd su un tipo oggetto datrasformare

### Novità: 4
- [#40304](https://parermine.regione.emilia-romagna.it/issues/40304) Modifica al titolo di due colonne nella lista strumenti urbanistici
- [#40302](https://parermine.regione.emilia-romagna.it/issues/40302) Modifica a ping-xml per elemento 
- [#40298](https://parermine.regione.emilia-romagna.it/issues/40298) Gestione della descrizione collegamento nell'oggetto dell'ufficio urbanistica
- [#40274](https://parermine.regione.emilia-romagna.it/issues/40274) Gestione dell'editing nel dettaglio strumento dell'ufficio urbanistica

## 9.0.1 (25-03-2026)

### Bugfix: 3
- [#40256](https://parermine.regione.emilia-romagna.it/issues/40256) Correzione della gestione delle altre fasi per la gestione del collegamento UD
- [#40148](https://parermine.regione.emilia-romagna.it/issues/40148) Correzione mancata scrittura campo DL_MSG_ERR tabella pig_log_job 
- [#40071](https://parermine.regione.emilia-romagna.it/issues/40071) Correzione dello svuotamento del campo priorità versamento e campo Trasformazione
...
### Bugfix: 6
- [#39226](https://parermine.regione.emilia-romagna.it/issues/39226) errore su dimensione massima in modifica dettaglio trasformazione
- [#39204](https://parermine.regione.emilia-romagna.it/issues/39204) Correzione della mancata apparizione del link "Scarica report"
- [#39072](https://parermine.regione.emilia-romagna.it/issues/39072) Correzione del problema stato versamento oggetto trasformato con UD VERSATA_ERR
- [#39005](https://parermine.regione.emilia-romagna.it/issues/39005) Correzione del lock su modifica parametro _UNPACK_INNER_PACKED_FILES
- [#38922](https://parermine.regione.emilia-romagna.it/issues/38922) Risoluzione dell'Errore 404 che si presenta nel tentativo di accedere al dettaglio dell'organizzazione dal dettaglio dell'ente convenzionato di SIAM
- [#38889](https://parermine.regione.emilia-romagna.it/issues/38889) Correzione  malfunzionamento nella gestione Log Eventi 

### Novità: 8
- [#39090](https://parermine.regione.emilia-romagna.it/issues/39090) Aggiungere alla ricerca oggetto un campo aggiuntivo tipo contenuto
- [#39012](https://parermine.regione.emilia-romagna.it/issues/39012) Modifiche alla pagina di monitoraggio per separare fascicoli e ud
- [#39011](https://parermine.regione.emilia-romagna.it/issues/39011) Gestione degli errori di coda
- [#39009](https://parermine.regione.emilia-romagna.it/issues/39009) annullamento fascicoli su sacer
- [#34475](https://parermine.regione.emilia-romagna.it/issues/34475)  Versamento DA_TRASFORMARE di fascicolo
- [#32984](https://parermine.regione.emilia-romagna.it/issues/32984) Creazione job  versamento fascicolo a sacer
- [#32983](https://parermine.regione.emilia-romagna.it/issues/32983) Modifica ai job di creazione xml per gestire i fascicoli
- [#32982](https://parermine.regione.emilia-romagna.it/issues/32982) Aggiungere al tipo oggetto un campo aggiuntivo tipo contenuto

## 8.1.3 (09-10-2025)

### Bugfix: 1
- [#39219](https://parermine.regione.emilia-romagna.it/issues/39219) Correzione possibile sovrapposizione dati appartenenti a sessioni diverse

## 8.1.2 (17-09-2025)

### Bugfix: 1
- [#39085](https://parermine.regione.emilia-romagna.it/issues/39085) Correzione del problema SISMA con errore PING-ERRSISMA19
