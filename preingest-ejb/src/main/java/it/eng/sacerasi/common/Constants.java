...
public class Constants {
    ...
    public static final String COD_VERS_ERR_CHIAVE_DUPLICATA_OLD = "UD-002"; // codice in uso fino a metà del 2013
    public static final String COD_VERS_ERR_CHIAVE_DUPLICATA_NEW = "UD-002-001"; // codice aggiornato, attivo dalla
    ...
    public enum StatoOggetto {
        ...
        ANNULLATO, CHIUSO_ERR_CODA, CHIUSO_ERR_CRASH_DPI, CHIUSO_ERR_CRASH_FS_PRIM, CHIUSO_ERR_CRASH_FS_SECOND,
        CHIUSO_ERR_CRASH_FTP, CHIUSO_ERR_NOTIF, CHIUSO_ERR_SCHED, CHIUSO_ERR_RECUPERABILE, CHIUSO_ERR_VERS,
        CHIUSO_ERR_VERSAMENTO_A_PING, CHIUSO_ERR_TRASFORMAZIONE, CHIUSO_OK, CHIUSO_WARNING, DA_TRASFORMARE,
        ERRORE_VERSAMENTO_A_PING, ERRORE_TRASFORMAZIONE, IN_ATTESA_FILE, IN_ATTESA_SCHED, IN_ATTESA_VERS, IN_CODA_VERS,
        IN_CORSO_ANNULLAMENTO, PREPARAZIONE_OGG_IN_CORSO, TRASFORMATO, TRASFORMAZIONE_NON_ATTIVA, VERSATO_A_PING,
        WARNING, WARNING_TRASFORMAZIONE, TRASFORMAZIONE_IN_CORSO, CHIUSO_ERR_VERIFICA_HASH, IN_CODA_HASH,
        // Stati fake lista riepilogo oggetti versati
        IN_CORSO_VERS_SACER, PROBLEMA_VERS_SACER, CHIUSO_ERR, PROBLEMA_PREPARAZIONE_SIP, WARNING_CHIAVE_DUPLICATA;
        ...
        public static StatoOggetto[] getStatiOggettoMonitoraggioListaOggetti() {
            return getEnums(CHIUSO_OK, IN_ATTESA_FILE, IN_ATTESA_SCHED, IN_ATTESA_VERS, IN_CODA_VERS, CHIUSO_ERR_VERS,
                    CHIUSO_ERR_RECUPERABILE, WARNING, CHIUSO_WARNING, DA_TRASFORMARE, TRASFORMAZIONE_NON_ATTIVA,
                    PREPARAZIONE_OGG_IN_CORSO, TRASFORMAZIONE_IN_CORSO, ERRORE_TRASFORMAZIONE, WARNING_TRASFORMAZIONE,
                    ...
                    CHIUSO_ERR_VERSAMENTO_A_PING, CHIUSO_ERR_SCHED, IN_CORSO_ANNULLAMENTO, ANNULLATO,
                    WARNING_CHIAVE_DUPLICATA, IN_CODA_HASH, CHIUSO_ERR_VERIFICA_HASH);
        }
        ...
        public static StatoOggetto[] getStatiOggettoTrasformazione() {
            return getEnums(IN_ATTESA_FILE, DA_TRASFORMARE, TRASFORMAZIONE_NON_ATTIVA, PREPARAZIONE_OGG_IN_CORSO,
                    ...
                    ERRORE_VERSAMENTO_A_PING, IN_CORSO_VERS_SACER, PROBLEMA_VERS_SACER, CHIUSO_ERR_TRASFORMAZIONE,
        ...
        public static StatoOggetto[] getStatiNoTrasformazione() {
            return getEnums(IN_ATTESA_FILE, IN_ATTESA_SCHED, IN_ATTESA_VERS, IN_CODA_VERS, WARNING, IN_CODA_HASH);
        }

    }

    public enum StatoSessioneIngest {
        ANNULLATA, CHIUSO_ERR, CHIUSO_ERR_CODA, CHIUSO_ERR_CRASH_DPI, CHIUSO_ERR_CRASH_FTP, CHIUSO_ERR_NOTIF,
        CHIUSO_ERR_SCHED, CHIUSO_ERR_RECUPERABILE, CHIUSO_ERR_VERS, CHIUSO_ERR_VERSAMENTO_A_PING,
        CHIUSO_ERR_TRASFORMAZIONE, CHIUSO_FORZATA, CHIUSO_OK, CHIUSO_WARNING, DA_TRASFORMARE, ERRORE_VERSAMENTO_A_PING,
        ERRORE_TRASFORMAZIONE, IN_ATTESA_FILE, IN_ATTESA_SCHED, IN_ATTESA_VERS, IN_CODA_VERS, IN_CORSO_ANNULLAMENTO,
        ...
        public static StatoSessioneIngest[] getStatiVersamentiFalliti() {
            return getEnums(CHIUSO_ERR, CHIUSO_ERR_NOTIF, CHIUSO_ERR_SCHED, CHIUSO_ERR_CODA, CHIUSO_ERR_VERS,
                    CHIUSO_ERR_RECUPERABILE, CHIUSO_ERR_TRASFORMAZIONE, CHIUSO_ERR_VERSAMENTO_A_PING);
        }
    ...
    public enum StatoSessioneRecup {
        CHIUSO_ERR, CHIUSO_ERR_ELIMINATO, CHIUSO_ERR_NOTIFICATO, CHIUSO_ERR_PRELEVATO, CHIUSO_ERR_RECUPERATO, CHIUSO_OK,
        ELIMINATO, IN_ATTESA_PRELIEVO, IN_ATTESA_RECUP, RECUPERATO;
    }

    public enum StatoUnitaDocObject {
        ANNULLATA, DA_VERSARE, ERR_CRASH_FS_PRIM, ERR_CRASH_FS_SECOND, IN_CODA_VERS, IN_CORSO_ANNULLAMENTO, VERSATA_ERR,
        VERSATA_OK, VERSATA_TIMEOUT, PREPARA_XML_IN_ERRORE, PREPARA_XML_OK
    }

    public enum StatoUnitaDocSessione {
        ANNULLATA, DA_VERSARE, IN_CODA_VERS, IN_CORSO_ANNULLAMENTO, VERSATA_ERR, VERSATA_OK, VERSATA_TIMEOUT,
        PREPARA_XML_IN_ERRORE;
    }
    ...
    public enum NomiJob {
        PREPARA_XML, PRODUCER_CODA_VERIFICA_H, PRODUCER_CODA_VERS, RECUPERA_ERRORI_IN_CODA, RECUPERA_VERS_ERR,
        RECUPERO_SACER, ALLINEAMENTO_ORGANIZZAZIONI, WS_MONITORAGGIO_STATUS, ESEGUI_TRASFORMAZIONE,
        ALLINEA_ENTI_CONVENZIONATI, VERIFICA_DOCUMENTI_STRUMENTI_URBANISTICI, INVIO_STRUMENTI_URBANISTICI,
        VERIFICA_DOCUMENTI_SISMA, INVIO_SISMA, INVIA_OGGETTI_GENERATI_A_PING, ALLINEAMENTO_LOG, INIZIALIZZAZIONE_LOG;
        ...
        public static NomiJob[] getComboSchedulazioniJob() {
            return getEnums(PREPARA_XML, PRODUCER_CODA_VERIFICA_H, PRODUCER_CODA_VERS, RECUPERA_ERRORI_IN_CODA,
                    RECUPERA_VERS_ERR, RECUPERO_SACER, ALLINEAMENTO_ORGANIZZAZIONI, ESEGUI_TRASFORMAZIONE,
                    INVIA_OGGETTI_GENERATI_A_PING, VERIFICA_DOCUMENTI_STRUMENTI_URBANISTICI,
                    INVIO_STRUMENTI_URBANISTICI, INVIO_SISMA, ALLINEAMENTO_LOG, INIZIALIZZAZIONE_LOG);
        }
    }
    ...
    public enum ServizioRecupero {
        ...
        RECUPERO_UD_SERVICE(Constants.RECUPERO_UD_SERVICE), RECUPERO_PC_SERVICE(Constants.RECUPERO_PC_SERVICE);
