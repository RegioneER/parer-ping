...
public class Constants {
    ...
    public static final String POOL_MAX_VERS_SACER = "POOL_MAX_VERS_SACER";
    public static final String POOL_MAX_PER_ROUTE_VERS_SACER = "POOL_MAX_PER_ROUTE_VERS_SACER";
