...
public class InfoCodaExt extends InfoCoda {
	...
	result = prime * result
		+ ((cdKeyUnitaDocSacer == null) ? 0 : cdKeyUnitaDocSacer.hashCode());
	result = prime * result
		+ ((cdRegistroUnitaDocSacer == null) ? 0 : cdRegistroUnitaDocSacer.hashCode());
	...
	result = prime * result
		+ ((undeliveredComment == null) ? 0 : undeliveredComment.hashCode());
	result = prime * result + ((undeliveredReason == null) ? 0 : undeliveredReason.hashCode());
	result = prime * result
		+ ((undeliveredTimestamp == null) ? 0 : undeliveredTimestamp.hashCode());
