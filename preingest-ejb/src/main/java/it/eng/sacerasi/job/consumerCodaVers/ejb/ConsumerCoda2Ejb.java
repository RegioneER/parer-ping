 ...
 * @author Agati_D
 */
@MessageDriven(name = "ConsumerCoda2", activationConfig = {
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge"),
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "queueType = 'CODA2'"),
...
public class ConsumerCoda2Ejb implements MessageListener {

    private static final String DESC_CONSUMER = "CCV2";
    Logger log = LoggerFactory.getLogger(ConsumerCoda2Ejb.class);
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            log.error(DESC_CONSUMER + " :: errore nel consumer, rollback transazione: ParerInternalError "
            ...
            log.error(DESC_CONSUMER + " :: errore nel consumer: JMSException " + ExceptionUtils.getRootCauseMessage(ex),
                    ex);
            mdc.setRollbackOnly();
        }
    }
