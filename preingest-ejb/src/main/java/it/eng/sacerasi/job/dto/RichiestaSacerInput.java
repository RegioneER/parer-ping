...
public class RichiestaSacerInput {
    ...
    public RichiestaSacerInput(TipoRichiestaSacer tipoRichiesta, String versioneWsDaInvocare, String urlRichiesta,
            String xmlRichiestaSacer, String xmlIndice, String userIdSacer, String passwordSacer, Integer timeout) {
    ...
    /**
     * @param xmlRichiestaSacer
     *            the xmlRichiestaSacer to set
     */
