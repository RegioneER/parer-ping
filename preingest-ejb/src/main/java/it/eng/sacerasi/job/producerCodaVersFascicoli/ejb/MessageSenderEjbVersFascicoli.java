 ...
 * @author Cappelli_F
 */
@Stateless(mappedName = "MessageSenderEjbVersFascicoli")
@LocalBean
public class MessageSenderEjbVersFascicoli {
    @Resource(mappedName = "jms/ProducerConnectionFactory")
    private ConnectionFactory connectionFactory;
    @Resource(mappedName = "jms/queue/ProducerCodaVersFascicoliQueue")
    private Queue queue;
