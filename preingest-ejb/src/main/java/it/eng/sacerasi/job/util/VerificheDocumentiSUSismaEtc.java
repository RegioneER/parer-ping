...
public class VerificheDocumentiSUSismaEtc {
    ...
    /**
     *
     * @param completeZipFileName es.: pippo.zip
     * @param entryInsideZip      es.: \pippo\paperino\file.doc
     *
     * @return false se la lunghezza complessiva del nome dello zip + entry maggiore 254 caratteri
     *         altrimenti true.
     */
     ...
     * @param charset il charset dello zip
     *
