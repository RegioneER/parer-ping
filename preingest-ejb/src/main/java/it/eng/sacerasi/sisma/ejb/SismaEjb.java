...
public class SismaEjb {
    ...
    public String getListaVersamentoString(BigDecimal id) {
        ...
        SismaHelper.DatiAnagraficiDto dtoDatiAnagrafici = getDatiVersatoreByIdVers(
    ...
    public SismaHelper.DatiAnagraficiDto getDatiVersatoreByIdVers(BigDecimal id) {
        return sismaHelper.getDatiAnagraficiByIdVers(id, null);
    }

    public SismaHelper.DatiAnagraficiDto getDatiVersatoreByIdVers(BigDecimal id, BigDecimal idSisma) {
    ...
    public SismaHelper.DatiAnagraficiDto getDatiVersatoreByIdVers(BigDecimal id, PigSisma pigSisma) {
        return sismaHelper.getDatiAnagraficiByIdVers(id, pigSisma);
    }
    ...
    public static String calcolaIdentificativo(BigDecimal anno, String codiceIntervento, String tiTipoAtto,
            String numero) {
    ...
    public static String calcolaCdKeyOS(String nmAmbiente, String nmVersatore, String cdKey) {
    ...
    public static class DocSismaDto extends GenericDto {
    ...
    public static class SismaDto extends GenericDto {
    ...
    public static class EsitoSalvataggioSisma {
