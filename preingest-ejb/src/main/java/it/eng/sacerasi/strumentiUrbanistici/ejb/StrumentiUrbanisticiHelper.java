...
public class StrumentiUrbanisticiHelper extends GenericHelper {
    ...
    public PigStrumUrbPianoStato getPigStrumUrbPianoStatoByNomeTipoByTipoAndFase(
	    String nmTipoStrumentoUrbanistico, String tiFaseStrumento) {
    ...
    public PigStrumUrbPianoDocReq getPigStrumUrbPianoDocReq(
	    PigStrumUrbPianoStato pigStrumUrbPianoStato, PigStrumUrbValDoc pigStrumUrbValDoc) {
    ...
    public PigStrumUrbDocumenti getPigStrumUrbDocumentiBySuNmFileOrig(
	    PigStrumentiUrbanistici pigStrumentiUrbanistici, String nmFileOrig) {
    ...
    public PigStrumentiUrbanistici aggiornaStato(PigStrumentiUrbanistici su,
	    PigStrumentiUrbanistici.TiStato tiStato) {
    ...
    public List<PigVSuLisDocsPiano> findPigVSuLisDocsPianoByTipoStrumentoFase(
	...
	Query query = getEntityManager().createQuery(
		"SELECT strumentiUrbanistici FROM PigStrumentiUrbanistici strumentiUrbanistici "
	...
	query.setParameter("idStrumentoUrbanistico",
    ...
    // MEV 31096
    public List<PigStrumUrbStoricoStati> PigStrumUrbStoricoStatiFromStrumentoUrbanistico(
	    BigDecimal idStrumento) {
	Query query = getEntityManager().createQuery(
    ...
    // MEV 31096
    public void creaStatoStorico(PigStrumentiUrbanistici pigStrumentiUrbanistici, String stato,
	    Date dtRegStato, String descrizione) {
    ...
    // MEV 34843
    public PigStrumUrbDocumenti getPigStrumUrbDocumentiByName(String nomefile,
	    BigDecimal idStrumento) {
	Query query = getEntityManager().createQuery(
