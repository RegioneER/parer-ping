...
public class MonitorCoda {
    ...
    /**
     * Effettua il redelivery di un messaggio alla coda specificata consumandolo dalla coda di
     * origine e inviandolo alla coda di destinazione
     *
    ...
    /**
     * Controlla se un messaggio è stato consumato. In base al messageSelector verifica nel db lo
     * stato del messaggio tramite il valore di paramToCheck
     *
     * @param messageSelector selettore
