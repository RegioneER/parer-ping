...
public class XmlContextCache {
	...
	try {
	    ...
	    // INIZIO SERVIZI PING
	    // Invio Async
	    versReqAsyncCtx_ListaUnitaDocumentarie = JAXBContext.newInstance(
		    ListaUnitaDocumentarieType.class,
		    it.eng.sacerasi.ws.xml.invioAsync.ObjectFactory.class);
	    invioAsyncSchema = schemaFctry.newSchema(it.eng.sacerasixml.xsd.FileXSDUtil
		    .getURLFileXSD(it.eng.sacerasixml.xsd.FileXSD.INVIO_ASYNC_XSD));
	    // Invio da trasf
	    ...
	    // DatiSpecOut
	    datispecOutCtx_ListaDatiSpecificiOut = JAXBContext.newInstance(
		    ListaDatiSpecificiOutType.class,
		    it.eng.sacerasi.ws.xml.datiSpecOut.ObjectFactory.class);
	    datispecOutSchema = schemaFctry.newSchema(it.eng.sacerasixml.xsd.FileXSDUtil
		    .getURLFileXSD(it.eng.sacerasixml.xsd.FileXSD.DATI_SPEC_OUT_XSD)); // DatiSpecOut
	    // DatiSpecOrder
	    datispecOrderCtx_ListaDatiSpecificiOrder = JAXBContext.newInstance(
		    ListaDatiSpecificiOrderType.class,
	    ...
	    // DatiSpecResult
	    datispecResultCtx_ListaValoriDatiSpecifici = JAXBContext.newInstance(
	    ...
	    invioSUSchema = schemaFctry.newSchema(it.eng.sacerasixml.xsd.FileXSDUtil
		    .getURLFileXSD(it.eng.sacerasixml.xsd.FileXSD.INVIO_SU_XSD));
	    // Invio Sisma
	    ...
	    invioSismaSchema = schemaFctry.newSchema(it.eng.sacerasixml.xsd.FileXSDUtil
		    .getURLFileXSD(it.eng.sacerasixml.xsd.FileXSD.INVIO_SISMA_XSD));

	    // MEV 31639 Unità Documentaria
	    unitaDocumentariaCtx_UnitaDocumentaria = JAXBContext.newInstance(
		    UnitaDocumentariaType.class,
	    ...
	    richAnnVersSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.ANNULLA_VERS_REQ_XSD));
	    ...
	    esitoRichAnnVersSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.ANNULLA_VERS_RESP_XSD));

	    // Servizi per versamento
	    versReqCtx_UD = JAXBContext.newInstance(
		    it.eng.parer.ws.xml.versReq.UnitaDocumentaria.class,
	    ...
	    versReqStatoSchema = schemaFctry
		    .newSchema(FileXSDUtil.getURLFileXSD(FileXSD.VERS_REQ_STATO_XSD));

	    versRespCtx_EsitoVersamento = JAXBContext.newInstance(
		    it.eng.parer.ws.xml.versResp.EsitoVersamento.class,
	    ...
	    // Servizi multimedia
	    versReqMMCtx_IndiceMM = JAXBContext.newInstance(
		    it.eng.parer.ws.xml.versReqMultiMedia.IndiceMM.class,
		    it.eng.parer.ws.xml.versReqMultiMedia.ObjectFactory.class);
	    versReqStatoMMCtx_IndiceMM = JAXBContext.newInstance(
		    it.eng.parer.ws.xml.versReqStatoMM.IndiceMM.class,
