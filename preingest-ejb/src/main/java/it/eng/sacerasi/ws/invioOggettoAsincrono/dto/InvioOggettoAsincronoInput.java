...
public class InvioOggettoAsincronoInput {
     ...
     * @param nmTipoObject         tipo oggetto
     * @param flFileCifrato        flag 1/0 (true/false)
     ...
     * @param cdVersioneXml        versione xml
     * @param xml                  contenuto xml
     * @param tiPrioritaVersamento priorita di versamento
     */
    public InvioOggettoAsincronoInput(String nmAmbiente, String nmVersatore, String cdKeyObject,
    ...
    /**
     * @param flFileCifrato the flFileCifrato to set
     */
    ...
    /**
     * @param flForzaWarning the flForzaWarning to set
     */
    ...
    /**
     * @param flForzaAccettazione the flForzaAccettazione to set
     */
    ...
    /**
     * @param cdVersioneXml the cdVersioneXml to set
     */
