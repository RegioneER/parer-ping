...
public class InvioOggettoAsincronoCheckEjb {
    ...
    public void checkSessione(InvioOggettoAsincronoExt invioOggettoAsincronoExt,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            rispostaControlli = controlliWS
                    .verificaNomeAmbiente(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getNmAmbiente());
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    rispostaControlli.setCodErr(MessaggiWSBundle.PING_SENDOBJ_001);
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_001,
                ...
                rispostaWs.getInvioOggettoAsincronoRisposta()
                        .setNmAmbiente(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getNmAmbiente());
            }
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_002,
                            invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getNmVersatore()));
                    setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                } else {
                    // Errore 666
                ...
                rispostaWs.getInvioOggettoAsincronoRisposta()
                        .setNmVersatore(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getNmVersatore());
            }
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            invioOggettoAsincronoExt.setFtpPath(StringUtils.stripToEmpty(rootFtp)
                    .concat(StringUtils.stripToEmpty(inputFtp)).concat(File.separator).concat(StringUtils
                            .stripToEmpty(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getCdKeyObject())));
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                ...
                rispostaWs.getInvioOggettoAsincronoRisposta()
                        .setCdKeyObject(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getCdKeyObject());
            }
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                ...
                rispostaWs.getInvioOggettoAsincronoRisposta()
                        .setNmTipoObject(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getNmTipoObject());
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR
                && StringUtils.isNotBlank(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getXml())
                && (invioOggettoAsincronoExt.getTiVersFile().equals(Constants.TipoVersamento.NO_ZIP.name())
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            rispostaControlli.reset();
            rispostaControlli = controlliInvioOggettoAsincrono.verificaAccettazioneMotivazione(idTipoObject,
        ...
        rispostaWs.getInvioOggettoAsincronoRisposta().setFlForzaAccettazione(
                invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().isFlForzaAccettazione());
        rispostaWs.getInvioOggettoAsincronoRisposta()
                .setFlForzaWarning(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().isFlForzaWarning());
        rispostaWs.getInvioOggettoAsincronoRisposta()
                .setFlFileCifrato(invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().isFlFileCifrato());
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            if (invioOggettoAsincronoExt.getInvioOggettoAsincronoInput() instanceof InvioOggettoAsincronoEstesoInput
                    && rispostaWs.getInvioOggettoAsincronoRisposta() instanceof InvioOggettoAsincronoEstesoRisposta) {
                ...
                if (StringUtils.isNotBlank(input.getNmAmbienteObjectPadre())
                    ...
                    // Gestione estesa
                    rispostaControlli = controlliWS.verificaCdKeyObject(input.getNmAmbienteObjectPadre(),
                            input.getNmVersatoreObjectPadre(), input.getCdKeyObjectPadre());
                    if (!rispostaControlli.isrBoolean() || (StringUtils.isNotBlank(rispostaControlli.getrString())
                            && rispostaControlli.getrString().equals(Constants.StatoOggetto.ANNULLATO.name()))) {
                        rispostaControlli.setCodErr(MessaggiWSBundle.PING_SENDOBJ_013);
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_013));
                        setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                    } else if (input.getNiTotObjectFigli() == null || input.getPgObjectFiglio() == null) {
                        rispostaControlli.setCodErr(MessaggiWSBundle.PING_SENDOBJ_014);
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_014));
                        setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                    } else {
                        ...
                        rispostaControlli.reset();
                        rispostaControlli = controlliInvioOggettoAsincrono.verificaOggettoFiglio(idObjectPadre,
                                input.getPgObjectFiglio());
                        if (rispostaControlli.isrBoolean()) {
                            rispostaControlli.setCodErr(MessaggiWSBundle.PING_SENDOBJ_015);
                            rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_015));
                            setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                        } else if (niTotObjectDb != null && niTotObjectDb.compareTo(input.getNiTotObjectFigli()) != 0) {
                            rispostaControlli.setCodErr(MessaggiWSBundle.PING_SENDOBJ_016);
                            rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_016));
                            setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                        } else if (niTotObjectDb != null && input.getPgObjectFiglio().compareTo(niTotObjectDb) > 0) {
                            rispostaControlli.setCodErr(MessaggiWSBundle.PING_SENDOBJ_017);
                            rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_017));
                            setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                        } else if (tiVersFile != null
                            ...
                            rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_018));
                            setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                        }
                    }
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_012));
                    setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                }
                if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                    rispostaControlli.reset();
                    ...
                    if (tiVersFile != null && tiVersFile.equals(Constants.TipoVersamento.DA_TRASFORMARE.name())) {
                        invioOggettoAsincronoExt.setTiGestOggettiFigli(input.getTiGestOggettiFigli());
                        if (StringUtils.isBlank(cdVersGen)) {
                            if (StringUtils.isBlank(invioOggettoAsincronoExt.getDsRegExpCdVers())) {
                                ...
                                Pattern regxp = Pattern.compile(invioOggettoAsincronoExt.getDsRegExpCdVers());
                                Matcher matcher = regxp.matcher(
                                        invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getCdKeyObject());
                                if (matcher.matches()) {
                                    ...
                                    rispostaControlli
                                            .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_022));
                                    setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                                }
                            }
                        }
                        if (StringUtils.isBlank(rispostaControlli.getCodErr())) {
                            if (StringUtils.isNotBlank(cdVersGen)) {
                                rispostaControlli = controlliInvioOggettoAsincrono
                                        .verificaCdVersGen(invioOggettoAsincronoExt.getIdTipoObject(), cdVersGen);
                                if (!rispostaControlli.isrBoolean()) {
                                    rispostaControlli.setCodErr(MessaggiWSBundle.PING_SENDOBJ_023);
                                    rispostaControlli
                                            .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_023));
                                    setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                                }
                            } else {
                                rispostaControlli.setCodErr(MessaggiWSBundle.PING_SENDOBJ_024);
                                rispostaControlli
                                        .setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_024));
                                setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                            }
                        }
                    } else {
                        ...
                        if (StringUtils.isNotBlank(input.getTiGestOggettiFigli())) {
                            ...
                            rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SENDOBJ_025));
                            setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                        }
                    }
                }
                // Risoluzione della MAC #14809 - WS invio oggetto: non viene calcolato il versatore per cui generare
                // oggetti
                // Nuovo ramo IF aggiunto
            } else if (invioOggettoAsincronoExt.getInvioOggettoAsincronoInput() instanceof InvioOggettoAsincronoInput
                    && rispostaWs.getInvioOggettoAsincronoRisposta() instanceof InvioOggettoAsincronoRisposta) {
                rispostaControlli.reset();
                if (tiVersFile != null && tiVersFile.equals(Constants.TipoVersamento.DA_TRASFORMARE.name())) {
                    rispostaControlli = controlliWS.verificaCdVersGenCasoNonEsteso(invioOggettoAsincronoExt);
                    if (!rispostaControlli.isrBoolean()) {
                        setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                    }
                }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            if (tiVersFile != null && tiVersFile.equals(Constants.TipoVersamento.DA_TRASFORMARE.name())
                ...
                invioOggettoAsincronoExt.setTiGestOggettiFigli(Constants.TipoGestioneOggettiFigli.AUTOMATICA.name());
            }
        }
    ...
    public Long checkObject(InvioOggettoAsincronoExt invioOggettoAsincronoExt,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            rispostaControlli = controlliWS.verificaCdKeyObject(
                    ...
                    invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getCdKeyObject());
            if (!rispostaControlli.isrBoolean()) {
                if (invioOggettoAsincronoExt.getNmTipoObject().equalsIgnoreCase(Constants.STUDIO_DICOM)) {
                    rispostaControlli.reset();
                    rispostaControlli = controlliInvioOggettoAsincrono.verificaOggettoDicom(
                            invioOggettoAsincronoExt.getIdTipoObject(), invioOggettoAsincronoExt.getDcmHashDicom(),
                    ...
                    if (!rispostaControlli.isrBoolean()) {
                        ...
                        setRispostaWsError(rispostaWs, SeverityEnum.WARNING, Constants.EsitoServizio.WARN,
                                rispostaControlli);
                    }
                }
            } else {
                ...
                rispostaControlli.reset();
                /*
                 * MEV#15178 - Modifica Tipo oggetto in dettaglio oggetto per gli oggetti da trasformare Inserito il
                 * controllo che se un oggetto esiste già ed il tipo oggetto è cambiato, la modifica è possibile se i
                 * due oggetti sono tutti e due dello stesso tipo (DA_TRASFORMARE)
                 */
                rispostaControlli = controlliInvioOggettoAsincrono.verificaModificaTipoOggetto(idObject,
                        invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().getNmTipoObject(),
                        invioOggettoAsincronoExt.getTiVersFile());
                if (!rispostaControlli.isrBoolean()) {
                    setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                ...
                if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                    rispostaControlli.reset();
                    rispostaControlli = controlliInvioOggettoAsincrono.verificaStatoOggetto(idObject,
                            invioOggettoAsincronoExt.getInvioOggettoAsincronoInput().isFlForzaAccettazione(),
                            invioOggettoAsincronoExt.getFtpPath(), invioOggettoAsincronoExt.getTiVersFile());
                    if (!rispostaControlli.isrBoolean()) {
                        if (rispostaControlli.getCodErr().equals(MessaggiWSBundle.PING_SENDOBJ_OBJ_004)) {
                            invioOggettoAsincronoExt.setFlRegistraObject(true);
                            invioOggettoAsincronoExt.setFlRegistraXMLObject(true);
                            invioOggettoAsincronoExt.setFlRegistraDatiSpecDicom(true);
                            setRispostaWsError(rispostaWs, SeverityEnum.WARNING, Constants.EsitoServizio.WARN,
                ...
                if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                    rispostaControlli.reset();
                    rispostaControlli = controlliInvioOggettoAsincrono.verificaOggettoPadre(idObject,
                            invioOggettoAsincronoExt.getIdOggettoPadre());
                    if (!rispostaControlli.isrBoolean()) {
                        setDefaultError(invioOggettoAsincronoExt, rispostaWs, rispostaControlli);
                    }
                }
    ...
    private void setRispostaWsError(RispostaWSInvioOggettoAsincrono rispostaWs, SeverityEnum sev, EsitoServizio esito,
