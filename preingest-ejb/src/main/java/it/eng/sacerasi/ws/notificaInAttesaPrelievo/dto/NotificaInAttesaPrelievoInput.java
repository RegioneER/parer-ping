...
public class NotificaInAttesaPrelievoInput {
    ...
    // public NotificaInAttesaPrelievoInput(String nmAmbiente, String nmVersatore, String
    // cdPassword, String
    // cdKeyObject) {
    ...
    // }
    public NotificaInAttesaPrelievoInput(String nmAmbiente, String nmVersatore,
	    String cdKeyObject) {
	this.nmAmbiente = nmAmbiente;
	this.nmVersatore = nmVersatore;
	this.cdKeyObject = cdKeyObject;
