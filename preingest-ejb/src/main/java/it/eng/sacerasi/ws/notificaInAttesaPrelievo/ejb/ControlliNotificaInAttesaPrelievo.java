...
public class ControlliNotificaInAttesaPrelievo {
    ...
    private static final Logger log = LoggerFactory.getLogger(ControlliNotificaInAttesaPrelievo.class);
    ...
    public RispostaControlli verificaOggetto(Long idObject) {
        ...
        try {
            ...
            if (!sessioni.isEmpty()) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_NOTIFATTESAPREL_006));
            }
        } catch (Exception e) {
            rispostaControlli.setrBoolean(false);
        ...
        if (rispostaControlli.isrBoolean()) {
            ...
            if (!sessione.getTiStato().equals(Constants.StatoSessioneRecup.RECUPERATO.name())) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_NOTIFATTESAPREL_007));
            }
        }
