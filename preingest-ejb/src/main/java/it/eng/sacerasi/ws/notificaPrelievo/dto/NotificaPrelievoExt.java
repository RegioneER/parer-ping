...
package it.eng.sacerasi.ws.notificaPrelievo.dto;
 ...
 * @author Bonora_L
 */
public class NotificaPrelievoExt implements ISoapWSBase {

    private IWSDesc descrizione;
    private NotificaPrelievoInput notificaPrelievoInput;
    ...
    /**
     * @return the notificaPrelievoInput
     */
    public NotificaPrelievoInput getNotificaPrelievoInput() {
        return notificaPrelievoInput;
    }

    /**
     * @param notificaPrelievoInput
     *            the notificaPrelievoInput to set
     */
    public void setNotificaPrelievoInput(NotificaPrelievoInput notificaPrelievoInput) {
        this.notificaPrelievoInput = notificaPrelievoInput;
    }
    ...
    /**
     * @param idSessioneRecup
     *            the idSessioneRecup to set
     */
