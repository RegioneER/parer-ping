 ...
 * @author Bonora_L
 */
public class NotificaPrelievoInput {
    ...
    // public NotificaPrelievoInput(String nmAmbiente, String nmVersatore, String cdPassword, String cdKeyObject) {
    public NotificaPrelievoInput(String nmAmbiente, String nmVersatore, String cdKeyObject) {
