 ...
 * @author Bonora_L
 */
public class RispostaWSNotificaPrelievo implements IRispostaWS {
    ...
    private NotificaPrelievoRisposta notificaPrelievoRisposta;
    ...
    /**
     * @param notificaPrelievoRisposta
     *            the notificaPrelievoRisposta to set
     */
