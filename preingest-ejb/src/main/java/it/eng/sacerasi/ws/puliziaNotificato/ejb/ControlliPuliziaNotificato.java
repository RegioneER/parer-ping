...
@Stateless(mappedName = "ControlliPuliziaNotificato")
@LocalBean
public class ControlliPuliziaNotificato {

    private static final Logger log = LoggerFactory.getLogger(ControlliPuliziaNotificato.class);
    ...
    public RispostaControlli verificaOggetto(Long idObject) {
        ...
        try {
            ...
            if (!sessioni.isEmpty()) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_ELIMINAPREL_006));
            }
        } catch (Exception e) {
            rispostaControlli.setrBoolean(false);
        ...
        if (rispostaControlli.isrBoolean()) {
            ...
            if (!sessione.getTiStato().equals(Constants.StatoOggetto.CHIUSO_OK.name())) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_ELIMINAPREL_007));
            }
        }
