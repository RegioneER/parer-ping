...
public class PuliziaNotificatoEjb {
    ...
    public PuliziaNotificatoRisposta puliziaNotificato(String nmAmbiente, String nmVersatore,
	    String cdKeyObject) {
	...
	PuliziaNotificatoInput inputParameters = new PuliziaNotificatoInput(nmAmbiente, nmVersatore,
		cdKeyObject);
	...
	if (StringUtils.isNotBlank(nmAmbiente) && StringUtils.isNotBlank(nmVersatore)
		...
		if (tmpRispCon.getCodErr() != null) {
		    ...
		    tmpRispCon.setDsErr(
			    MessaggiWSBundle.getString(MessaggiWSBundle.ERR_PULIZIA_NOTIFICATO));
    ...
    private void setRispostaWsError(RispostaWSPuliziaNotificato risp,
