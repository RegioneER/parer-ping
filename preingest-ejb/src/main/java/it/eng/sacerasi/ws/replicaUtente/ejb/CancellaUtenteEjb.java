...
public class CancellaUtenteEjb {
    ...
    public void deleteIamUser(CancellaUtenteExt cuExt, RispostaWSCancellaUtente rispostaWs) throws ParerInternalError {
        try {
            ...
            rispostaWs.setErrorMessage(
                    "Errore nella cancellazione dell'utente " + ExceptionUtils.getRootCauseMessage(ex));
            throw new ParerInternalError(ParerErrorSeverity.ERROR,
                    "Errore nella cancellazione dell'utente " + ExceptionUtils.getRootCauseMessage(ex), ex);
        }
    }
}
