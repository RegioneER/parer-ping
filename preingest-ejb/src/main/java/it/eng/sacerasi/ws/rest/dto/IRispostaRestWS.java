 ...
 * dell'implementazione del primo ws rest in PING l'interfaccia IRispostaWS era già usata
 * massivamente per i servizi SOAP ed era meno completa. Integrare questi metodi in IRispostaWS
 * avrebbe comportato un lavoro di refactoring improbo.
 *
 * @author fioravanti_f
 */
