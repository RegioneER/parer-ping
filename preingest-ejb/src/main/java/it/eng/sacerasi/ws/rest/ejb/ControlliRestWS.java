...
/**
 * Questa classe è un sottoinsieme della classe ControlliWS di SACER. La classe ControlliWS di PING
 * svolge compiti differenti e non mi pareva il caso di integrare questi metodi
 *
 * @author fioravanti_f
 */
