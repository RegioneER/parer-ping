    ...
    public void scriviLog(LogDto logDto) {
        ...
        if (iamDefaults.get(Constants.IDP_QRY_REGISTRA_EVENTO_UTENTE) != null
            ...
            try {
                ...
                icl.setQryRegistraEventoUtente(iamDefaults.get(Constants.IDP_QRY_REGISTRA_EVENTO_UTENTE));
                ...
                icl.setMaxTentativi(Integer.parseInt(iamDefaults.get(Constants.IDP_MAX_TENTATIVI_FALLITI)));
                ...
                if (connection != null) {
                    try {
                        ...
                        throw new RuntimeException(
                                "WsIdpLogger: Errore nella chiusura della connessione: " + ex.getMessage());
                    }
                }
            }
