...
public class RicercaDiarioEjb {
    ...
    public RicercaDiarioRisposta ricercaDiario(String nmAmbiente, String nmVersatore, String nmTipoObject,
            String cdKeyObject, Long idSessione, String tiStatoObject, boolean flTutteSessioni, Integer niRecordInizio,
            Integer niRecordResultSet, String xmlDatiSpecOutput, String xmlDatiSpecFiltri, String xmlDatiSpecOrder) {
        ...
        RicercaDiarioInput rdInput = new RicercaDiarioInput(nmAmbiente, nmVersatore, nmTipoObject, cdKeyObject,
                idSessione, tiStatoObject, flTutteSessioni, niRecordInizio, niRecordResultSet, xmlDatiSpecOutput,
        ...
        // 2: Chiamo la classe RicercaDiarioParser per "parsare" gli xml di input (filtri, output, order), se questi
        // sono presenti
        ...
        if (rispostaWs.getSeverity() != IRispostaWS.SeverityEnum.ERROR) {
            ...
            List<DatoSpecOutputConNomeColonna> datiSpecOutputConNomeColonna = rdExt.getDatiSpecOutputConNomeColonna();
            ...
            if (rispostaWs.getSeverity() != IRispostaWS.SeverityEnum.ERROR) {
                listaOggetti = executeQueries.eseguiQueryRicerca(rdExt, datiSpecOutputConNomeColonna, queryRicerca,
