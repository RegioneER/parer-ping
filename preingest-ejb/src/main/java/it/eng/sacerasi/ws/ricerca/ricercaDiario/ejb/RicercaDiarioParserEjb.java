...
public class RicercaDiarioParserEjb {
    ...
    public void parseXMLDatiSpecFiltri(RicercaDiarioExt ricercaDiarioExt, RispostaWSRicercaDiario rispostaWs) {
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            try {
                ...
                rispostaWs.setErrorMessage(
                        MessaggiWSBundle.getString(MessaggiWSBundle.ERR_XML_MALFORMED, e.getLocalizedMessage()));
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            // Eseguo il controllo
            rispostaControlli = controlliRicerca.verificaXMLDatiSpecFiltri(ricercaDiarioExt.getIdTipoObject(),
                    listaDatiSpecFiltriConNomeColonna, ricercaDiarioExt.getListaAttribDatiSpec());
            if (!rispostaControlli.isrBoolean()) {
                switch (rispostaControlli.getCodErr()) {
                case "006":
                    rispostaControlli.setCodErr(MessaggiWSBundle.PING_DIARIO_006);
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_DIARIO_006,
                            rispostaControlli.getrObject(), rispostaControlli.getrString()));
                    break;
                case "007":
                    rispostaControlli.setCodErr(MessaggiWSBundle.PING_DIARIO_007);
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_DIARIO_007,
                            rispostaControlli.getrObject(), rispostaControlli.getrString()));
                    break;
                case "666":
    ...
    public void parseXMLDatiSpecOutput(RicercaDiarioExt ricercaDiarioExt, RispostaWSRicercaDiario rispostaWs) {
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                ...
                rispostaControlli = controlliRicerca.verificaXMLDatiSpecOutput(ricercaDiarioExt.getIdTipoObject(),
                        listaDatiSpecOutput, ricercaDiarioExt.getListaAttribDatiSpec());
                if (!rispostaControlli.isrBoolean()) {
                    switch (rispostaControlli.getCodErr()) {
                    case "008":
                        rispostaControlli.setCodErr(MessaggiWSBundle.PING_DIARIO_008);
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_DIARIO_008,
                                rispostaControlli.getrObject(), rispostaControlli.getrString()));
                        break;
                    case "666":
                        rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
                    ...
                    ricercaDiarioExt.setDatiSpecOutputConNomeColonna(listaDatiSpecOutputConNomeColonna);
                }
            }
        }
    }

    public void parseXMLDatiSpecOrder(RicercaDiarioExt ricercaDiarioExt, RispostaWSRicercaDiario rispostaWs) {
        /*
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                ...
                rispostaControlli = controlliRicerca.verificaXMLDatiSpecOrder(ricercaDiarioExt.getIdTipoObject(),
                        listaDatiSpecOrderConNomeColonna, ricercaDiarioExt.getListaAttribDatiSpec());
                if (!rispostaControlli.isrBoolean()) {
                    switch (rispostaControlli.getCodErr()) {
                    case "009":
                        rispostaControlli.setCodErr(MessaggiWSBundle.PING_DIARIO_009);
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_DIARIO_009,
                                rispostaControlli.getrObject(), rispostaControlli.getrString()));
                        break;
                    case "666":
                        rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
    ...
    public String parseDatiSpecResult(ListaValoriDatiSpecificiType lista, RicercaDiarioExt ricercaDiarioExt,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            try {
                ...
                JAXBElement<ListaValoriDatiSpecificiType> elemento = factory.createListaValoriDatiSpecifici(lista);
    ...
    private void setRispostaWsError(RispostaWSRicercaDiario rispostaWs, RispostaControlli rispostaControlli) {
        rispostaWs.setSeverity(SeverityEnum.ERROR);
