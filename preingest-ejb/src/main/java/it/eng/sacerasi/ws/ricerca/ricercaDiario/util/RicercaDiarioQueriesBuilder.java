...
public class RicercaDiarioQueriesBuilder {
	...
	// Se FlTutteSessioni vale true, è un parametro obbligatorio quindi non controllo che ci sia
	// o meno
	if (ricercaDiarioExt.getRicercaDiarioInput().isFlTutteSessioni()) {
	    whereCondition = new StringBuilder(
		    "WHERE oggetto.idObject = sessione_ingest.pigObject.idObject ");
	} else {
	    whereCondition = new StringBuilder(
	...
	if (StringUtils.isNotBlank(ricercaDiarioExt.getRicercaDiarioInput().getNmAmbiente())) {
	    whereCondition.append("AND sessione_ingest.nmAmbienteVers = :valore")
	...
	if (StringUtils.isNotBlank(ricercaDiarioExt.getRicercaDiarioInput().getNmVersatore())) {
	    whereCondition.append("AND sessione_ingest.nmVers = :valore").append(contatoreValori)
		    .append(" ");
	    valoriQuery.put(":valore" + contatoreValori,
	...
	if (StringUtils.isNotBlank(ricercaDiarioExt.getRicercaDiarioInput().getCdKeyObject())) {
	    whereCondition.append("AND oggetto.cdKeyObject = :valore").append(contatoreValori)
		    .append(" ");
	    valoriQuery.put(":valore" + contatoreValori,
		    ricercaDiarioExt.getRicercaDiarioInput().getCdKeyObject());
	    contatoreValori++;
	}
	if (ricercaDiarioExt.getRicercaDiarioInput().getIdSessione() != null) {
	    whereCondition.append("AND sessione_ingest.idSessioneIngest = :valore")
		    .append(contatoreValori).append(" ");
	    valoriQuery.put(":valore" + contatoreValori,
		    ricercaDiarioExt.getRicercaDiarioInput().getIdSessione());
	    contatoreValori++;
	}
	if (StringUtils.isNotBlank(ricercaDiarioExt.getRicercaDiarioInput().getTiStatoObject())) {
	    whereCondition.append("AND oggetto.tiStatoObject = :valore").append(contatoreValori)
		    .append(" ");
	    valoriQuery.put(":valore" + contatoreValori,
		    ricercaDiarioExt.getRicercaDiarioInput().getTiStatoObject());
	    contatoreValori++;
	}
	...
	if (ricercaDiarioExt.getRicercaDiarioInput().getNmTipoObject() != null) {
	    ...
	    if (ricercaDiarioExt.getRicercaDiarioInput().getNmTipoObject()
		...
		if (StringUtils.isNotBlank(
			...
			// Ricavo il filtro dato specifico guardando quale dei 3 casi � diverso da
			// null
		...
		if (StringUtils.isNotBlank(
		    ...
		    for (DatoSpecOrderConNomeColonna dato : ricercaDiarioExt
