...
public class RicercaRestituzioniOggettiEjb {
    ...
    public RicercaRestituzioniOggettiRisposta ricercaRestituzioniOggetti(String nmAmbiente, String nmVersatore,
            String nmTipoObject, String cdKeyObject, String tiStatoSessione, Date dtAperturaSessioneDa,
            Date dtAperturaSessioneA, Integer niRecordInizio, Integer niRecordResultSet, String xmlDatiSpecOutput,
        ...
        RicercaRestituzioniOggettiInput rroInput = new RicercaRestituzioniOggettiInput(nmAmbiente, nmVersatore,
                nmTipoObject, cdKeyObject, tiStatoSessione, dtAperturaSessioneDa, dtAperturaSessioneA, niRecordInizio,
        ...
        // 1: Chiamo la classe RicercaRestituzioniOggettiCheck che gestisce i controlli di sessione e di oggetto e
        // popola la rispostaWs
        ricercaRestituzioniOggettiCheckHelper.checkSessione(rroExt, rispostaWs);

        // 2: Chiamo la classe RicercaRestituzioniOggettiParser per "parsare" gli xml di input (filtri, output, order),
        ...
        RicercaRestituzioniOggettiQueriesBuilder queriesBuilder = new RicercaRestituzioniOggettiQueriesBuilder(rroExt);
        ...
        if (rispostaWs.getSeverity() != IRispostaWS.SeverityEnum.ERROR) {
            ...
            List<DatoSpecOutputConNomeColonna> datiSpecOutputConNomeColonna = rroExt.getDatiSpecOutputConNomeColonna();
            ...
            if (rispostaWs.getSeverity() != IRispostaWS.SeverityEnum.ERROR) {
                listaOggetti = executeQueries.eseguiQueryRicerca(rroExt, datiSpecOutputConNomeColonna, queryRicerca,
                        valoriParametriQuery, inizio, niRecordResultSet, cdKeyObject, rispostaWs);
            }
            ...
            /*
             * Setto il numero di record restituiti dalla query di ricerca (dipende dai valori NiRecordInizio e
             * NiRecordResultSet passati in input)
             */
