...
public class RicercaRestituzioniOggettiExecuteQueries {
    ...
    private static final Logger log = LoggerFactory.getLogger(RicercaRestituzioniOggettiExecuteQueries.class);
    ...
    public Long eseguiQueryConta(String queryConta, Map<?, ?> valoriParametriQuery,
        ...
        try {
            ...
            rispostaWs.getricercaRestituzioniOggettiRisposta().setDsErr(
                    MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666, "errore nell'esecuzione della query conta"));
        }
        return conta;
    }
        ...
        try {
            ...
            for (Object[] o : resultSet) {
                ...
                if (datiSpecOutputConNomeColonna != null) {
                    ...
                    for (DatoSpecOutputConNomeColonna dato : datiSpecOutputConNomeColonna) {
                        ...
                        if (o[indice + contatore] instanceof Date) {
                            try {
                                ...
                                log.error("Errore nella formattazione del campo data in output: " + e.getMessage());
                            }
                     ...
                     */
                    obj.setXmlDatiSpecResult(
                            ricercaRestituzioniOggettiParser.parseDatiSpecResult(listaDS, rroExt, rispostaWs));
                    ...
                    if (numUD == 0) {
                        ...
                        obj.setChiaveUnitaDoc("Il numero di unità documentarie generate dall'oggetto è > 1");
                    }
                }
            ...
            rispostaWs.getricercaRestituzioniOggettiRisposta().setDsErr(MessaggiWSBundle
                    .getString(MessaggiWSBundle.ERR_666, "errore nell'esecuzione della query di ricerca"));
        }
        return listaOggType;
    }
