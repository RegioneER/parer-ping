...
public class RicercaRestituzioniOggettiParserEjb {
    ...
    private static final Logger log = LoggerFactory
            .getLogger(RicercaRestituzioniOggettiParserEjb.class);
     ...
     */
    private void initLisAttribDatiSpecByIdTipoObj(
    ...
    public void parseXMLDatiSpecFiltri(RicercaRestituzioniOggettiExt ricercaRestituzioniOggettiExt,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            String datiXml = ricercaRestituzioniOggettiExt.getRicercaRestituzioniOggettiInput()
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            rispostaControlli = controlliRicerca.verificaXMLDatiSpecFiltri(
                    ricercaRestituzioniOggettiExt.getIdTipoObject(),
                    listaDatiSpecFiltriConNomeColonna,
            ...
            if (!rispostaControlli.isrBoolean()) {
                ...
                case "006":
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                            MessaggiWSBundle.PING_RESTIT_006, rispostaControlli.getrObject(),
                            rispostaControlli.getrString()));
                    break;
                case "007":
                    rispostaControlli.setCodErr(MessaggiWSBundle.PING_RESTIT_007);
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                            MessaggiWSBundle.PING_RESTIT_007, rispostaControlli.getrObject(),
                            rispostaControlli.getrString()));
                    break;
                case "666":
    ...
    public void parseXMLDatiSpecOutput(RicercaRestituzioniOggettiExt ricercaRestituzioniOggettiExt,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            try {
                ...
                rispostaWs.getricercaRestituzioniOggettiRisposta()
                        .setCdErr(MessaggiWSBundle.ERR_666);
                rispostaWs.getricercaRestituzioniOggettiRisposta().setDsErr(MessaggiWSBundle
                        .getString(MessaggiWSBundle.ERR_666, e.getLocalizedMessage()));
                log.error(MessaggiWSBundle.getString(MessaggiWSBundle.ERR_666), e);
            } catch (ValidationException e) {
                rispostaWs.setSeverity(SeverityEnum.ERROR);
                rispostaWs.setErrorCode(MessaggiWSBundle.ERR_XML_MALFORMED);
            ...
            if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                rispostaControlli.reset();
                List<String> listaDatiSpecOutput = parsedListaDatiSpecificiOut != null
                        ? parsedListaDatiSpecificiOut.getDatoSpecificoOut()
                        : new ArrayList<>();
                ...
                if (!rispostaControlli.isrBoolean()) {
                    ...
                    case "008":
                        ...
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                                MessaggiWSBundle.PING_RESTIT_008, rispostaControlli.getrObject(),
                                rispostaControlli.getrString()));
                        break;
                    case "666":
                        rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
                    ...
                    // LinkedHashMap listaDatiSpecOutputConNomeColonna = (LinkedHashMap<String,
                    // String>)
    ...
    public void parseXMLDatiSpecOrder(RicercaRestituzioniOggettiExt ricercaRestituzioniOggettiExt,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
                ...
                if (parsedListaDatiSpecificiOrder != null) {
                    for (OrderType dato : parsedListaDatiSpecificiOrder.getDatoSpecificoOrder()) {
                        DatoSpecOrderConNomeColonna ds = new DatoSpecOrderConNomeColonna(dato,
                                null);
                ...
                rispostaControlli = controlliRicerca.verificaXMLDatiSpecOrder(
                        ricercaRestituzioniOggettiExt.getIdTipoObject(),
                        listaDatiSpecOrderConNomeColonna,
                        ricercaRestituzioniOggettiExt.getListaAttribDatiSpec());
                if (!rispostaControlli.isrBoolean()) {
                    switch (rispostaControlli.getCodErr()) {
                    case "009":
                        ...
                        rispostaControlli.setDsErr(MessaggiWSBundle.getString(
                                MessaggiWSBundle.PING_RESTIT_009, rispostaControlli.getrObject(),
                                rispostaControlli.getrString()));
                        break;
                    case "666":
                        rispostaControlli.setCodErr(MessaggiWSBundle.ERR_666);
