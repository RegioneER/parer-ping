...
public class RicercaRestituzioniOggettiCheckHelper {
    ...
    public void checkSessione(RicercaRestituzioniOggettiExt ricercaRestituzioniOggettiExt,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_RESTIT_001,
                            ricercaRestituzioniOggettiExt.getRicercaRestituzioniOggettiInput().getNmAmbiente()));
            ...
            rispostaWs.getricercaRestituzioniOggettiRisposta()
                    .setNmAmbiente(ricercaRestituzioniOggettiExt.getRicercaRestituzioniOggettiInput().getNmAmbiente());
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_RESTIT_002,
                            ricercaRestituzioniOggettiExt.getRicercaRestituzioniOggettiInput().getNmVersatore()));
                    setRispostaWsError(rispostaWs, SeverityEnum.ERROR, Constants.EsitoServizio.KO, rispostaControlli);
                } else {
                    // Errore 666
            ...
            rispostaWs.getricercaRestituzioniOggettiRisposta().setNmVersatore(
                    ricercaRestituzioniOggettiExt.getRicercaRestituzioniOggettiInput().getNmVersatore());
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            rispostaWs.getricercaRestituzioniOggettiRisposta().setNmTipoObject(
                    ricercaRestituzioniOggettiExt.getRicercaRestituzioniOggettiInput().getNmTipoObject());
        }
    ...
    private void setRispostaWsError(RispostaWSRicercaRestituzioniOggetti rispostaWs, SeverityEnum sev,
