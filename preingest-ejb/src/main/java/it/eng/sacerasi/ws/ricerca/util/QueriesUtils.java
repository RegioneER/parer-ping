...
public class QueriesUtils {
    ...
    public static Map<String, String[]> getMappingOperazione() {
        ...
        op.put(OperatoreType.INIZIA_PER.name(), new String[] { "LIKE", "", "%" });
        op.put(OperatoreType.CONTIENE.name(), new String[] { "LIKE", "%", "%" });
        op.put(OperatoreType.NON_CONTIENE.name(), new String[] { "NOT LIKE", "%", "%" });
        op.put(OperatoreType.IN.name(), new String[] { "IN", "", "" });
        return op;
    }
