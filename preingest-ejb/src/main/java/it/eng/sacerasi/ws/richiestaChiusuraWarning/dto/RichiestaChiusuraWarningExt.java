...
public class RichiestaChiusuraWarningExt implements ISoapWSBase {
    ...
    /**
     * @param richiestaChiusuraWarningInput
     *            the richiestaChiusuraWarningInput to set
     */
    public void setRichiestaChiusuraWarningInput(RichiestaChiusuraWarningInput richiestaChiusuraWarningInput) {
