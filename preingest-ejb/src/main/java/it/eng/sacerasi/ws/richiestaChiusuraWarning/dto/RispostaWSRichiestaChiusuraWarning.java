...
public class RispostaWSRichiestaChiusuraWarning implements IRispostaWS {
    ...
    /**
     * @param richiestaChiusuraWarningRisposta the richiestaChiusuraWarningRisposta to set
     */
    public void setRichiestaChiusuraWarningRisposta(
	    RichiestaChiusuraWarningRisposta richiestaChiusuraWarningRisposta) {
