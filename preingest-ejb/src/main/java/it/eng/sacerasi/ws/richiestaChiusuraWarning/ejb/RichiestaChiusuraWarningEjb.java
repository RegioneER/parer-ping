...
public class RichiestaChiusuraWarningEjb {
    ...
    public RichiestaChiusuraWarningRisposta richiestaChiusuraWarning(String nmAmbiente,
	    String nmVersatore, String cdKeyObject, String dlMotivazione) {
	...
	// RichiestaChiusuraWarningInput inputParameters = new
	// RichiestaChiusuraWarningInput(nmAmbiente, nmVersatore,
	// cdPassword, cdKeyObject, dlMotivazione);
	RichiestaChiusuraWarningInput inputParameters = new RichiestaChiusuraWarningInput(
		nmAmbiente, nmVersatore, cdKeyObject, dlMotivazione);
	...
	// Chiamo la classe RichiestaChiusuraWarningCheck che gestisce i controlli e popola la
	// rispostaWs
    ...
    private void setRispostaWsError(RispostaWSRichiestaChiusuraWarning risp,
