...
public class RichiestaChiusuraWarningCheckHelper {
    ...
    public void checkRichiesta(RichiestaChiusuraWarningExt rcwe, RispostaWSRichiestaChiusuraWarning rispostaWs) {
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_CHIUWARN_001,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_CHIUWARN_002,
                            rcwe.getRichiestaChiusuraWarningInput().getNmVersatore()));
                    setRispostaWsError(rispostaWs, SeverityEnum.ERROR, Constants.EsitoServizio.KO, rispostaControlli);
                } else {
                    // Errore 666
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            rispostaControlli = controlliWS.verificaNotBlankCdKeyObject(
                    rcwe.getRichiestaChiusuraWarningInput().getCdKeyObject(), MessaggiWSBundle.PING_CHIUWARN_004);
            if (!rispostaControlli.isrBoolean()) {
                setRispostaWsError(rispostaWs, SeverityEnum.ERROR, Constants.EsitoServizio.KO, rispostaControlli);
            }
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            rispostaControlli = controlliWS.verificaCdKeyObjectLength(
                    rcwe.getRichiestaChiusuraWarningInput().getCdKeyObject(), MessaggiWSBundle.PING_CHIUWARN_008);
            if (!rispostaControlli.isrBoolean()) {
                setRispostaWsError(rispostaWs, SeverityEnum.ERROR, Constants.EsitoServizio.KO, rispostaControlli);
            }
        }
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            rispostaControlli.reset();
            rispostaControlli = controlliWS.verificaCdKeyObject(rcwe.getRichiestaChiusuraWarningInput().getNmAmbiente(),
                    rcwe.getRichiestaChiusuraWarningInput().getNmVersatore(),
                    rcwe.getRichiestaChiusuraWarningInput().getCdKeyObject());
            if (!rispostaControlli.isrBoolean()) {
                rispostaControlli.setCodErr(MessaggiWSBundle.PING_CHIUWARN_005);
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_CHIUWARN_005,
                        rcwe.getRichiestaChiusuraWarningInput().getCdKeyObject()));
                setRispostaWsError(rispostaWs, SeverityEnum.ERROR, Constants.EsitoServizio.KO, rispostaControlli);
            } else {
                rispostaWs.getRichiestaChiusuraWarningRisposta()
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            rispostaControlli.reset();
            rispostaControlli = controlliWS.verificaStatoOggetto(idObject, Constants.StatoOggetto.WARNING,
                    MessaggiWSBundle.PING_CHIUWARN_006);
            if (!rispostaControlli.isrBoolean()) {
                setRispostaWsError(rispostaWs, SeverityEnum.ERROR, Constants.EsitoServizio.KO, rispostaControlli);
            } else {
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (StringUtils.isBlank(rcwe.getRichiestaChiusuraWarningInput().getDlMotivazione())) {
                ...
                rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_CHIUWARN_007));
                setRispostaWsError(rispostaWs, SeverityEnum.ERROR, Constants.EsitoServizio.KO, rispostaControlli);
            }
        }
    }
