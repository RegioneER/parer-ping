 ...
 * @author Bonora_L
 */
public class RichiestaRestituzioneOggettoInput {
    ...
    // public RichiestaRestituzioneOggettoInput(String nmAmbiente, String nmVersatore, String cdPassword, String
    // cdKeyObject) {
    public RichiestaRestituzioneOggettoInput(String nmAmbiente, String nmVersatore, String cdKeyObject) {
