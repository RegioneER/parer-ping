 ...
 * @author Bonora_L
 */
public class RispostaWSRichiestaRestituzioneOggetto implements IRispostaWS {
    ...
    private RichiestaRestituzioneOggettoRisposta richiestaRestituzioneOggettoRisposta;
