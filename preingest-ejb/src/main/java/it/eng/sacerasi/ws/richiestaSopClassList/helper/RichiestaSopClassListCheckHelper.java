...
public class RichiestaSopClassListCheckHelper {
    ...
    public void checkRichiesta(RichiestaSopClassListExt rsclExt, RispostaWSRichiestaSopClassList rispostaWs) {
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SOP_001,
        ...
        if (rispostaWs.getSeverity() != SeverityEnum.ERROR) {
            ...
            if (!rispostaControlli.isrBoolean()) {
                if (rispostaControlli.getCodErr() == null) {
                    ...
                    rispostaControlli.setDsErr(MessaggiWSBundle.getString(MessaggiWSBundle.PING_SOP_002,
                            rsclExt.getRichiestaSopClassListInput().getNmVersatore()));
                    setRispostaWsError(rispostaWs, SeverityEnum.ERROR, Constants.EsitoServizio.KO, rispostaControlli);
                } else {
                    // Errore 666
