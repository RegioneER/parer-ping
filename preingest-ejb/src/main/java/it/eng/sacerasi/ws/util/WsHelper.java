...
public class WsHelper {
    ...
    public void checkAuthorizations(String nmAmbiente, String nmVersatore, String username, String servizioWeb)
    ...
    private Integer retrieveIdOrgFromNmAmbienteAndNmVersatore(String nmAmbiente, String nmVersatore) {
        Query q = em
                .createQuery("SELECT pigVers.idVers " + "FROM PigVers pigVers JOIN pigVers.pigAmbienteVer ambienteVers "
                        + "where pigVers.nmVers = :nmVersatore " + "and ambienteVers.nmAmbienteVers = :nmAmbiente");
