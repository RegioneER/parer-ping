...
public class KettleWsClient {
    ...
    /*
     * Metodo che innesca l'inizio della <em>Trasformazione</em>. Lo stato che il
     * <tt>PIG_OBJECT</tt> deve assumere in caso di esito positivo deve essere
     * <tt>TRASFORMAZIONE_IN_CORSO</tt> .
     *
     ...
     *
     * @param jobXmlFile     file xml
     * @param versionComment versione
     *
    ...
    /**
     * Inserimento della trasformation di kettle. Necessario utilizzare <em>MTOM</em> per trasferire
     * il file.
     *
     * @param transformationXmlFile file trasformato xml
     * @param versionComment        versione
     *
     * @throws KettleException errore generico
     */
     ...
     *
     * @param nomeCartella nome della cartella/trasformazione
     *
     * @throws KettleException errore generico
     */
     ...
     *
     * @param nomeTrasformazione nome della trasformazione/cartella.
     *
     * @return Lista dei parametri associati alla trasformazione/cartella.
     *
     * @throws KettleException        errore generico
     * @throws KettleServiceException errore generico
     *
     */
     ...
     * Ottieni la lista dei parametri della trasformazione.
     *
     * @param nomeCartella nome della trasformazione/cartella.
     *
