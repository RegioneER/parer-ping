...
public abstract class ArquillianUtils {
	...
	javaArchive.addPackage("it.eng.sequences.hibernate")
		.addClasses(it.eng.paginator.hibernate.OracleSqlInterceptor.class,
			ArquillianUtils.class, org.apache.commons.lang3.StringUtils.class,
			it.eng.spagoCore.error.EMFError.class)
		.addPackages(true, "it.eng.parer.sacerlog.entity",
			"it.eng.parer.sacerlog.viewEntity", "it.eng.paginator", "it.eng.spagoLite",
			"it.eng.sacerasi.common", "it.eng.sacerasi.exception",
			"it.eng.sacerasi.entity", "it.eng.sacerasi.grantEntity",
			"it.eng.sacerasi.viewEntity", "it.eng.sacerasi.slite.gen",
			"org.apache.commons.lang3")
		.addClass("it.eng.sacerasi.web.helper.ConfigurationHelper")
		.addClass("it.eng.sacerasi.web.helper.dto.PigVGetValParamDto")
		.addClass("it.eng.sacerasi.helper.GenericHelper")
		.addClass("it.eng.sacerasi.helper.HelperInterface")
		.addClass("it.eng.RollbackException").addClass("it.eng.ExpectedException")
		.addClass(clazz);
	return javaArchive;
    }
	...
	return ShrinkWrap.create(JavaArchive.class, "timers.jar")
	...
	throwExceptionIf(ExpectedException.class, e, "No entity found", "NoResultException",
		"ParerNoResultException", "it.eng.parer.exception.errors",
	...
	throwExceptionIf(RollbackException.class, e, "No entity found", "NoResultException",
		"ParerNoResultException", "it.eng.parer.exception.errors",
		"java.lang.NullPointerException", "java.lang.IndexOutOfBoundsException",
		"ParerUserError");
    }
