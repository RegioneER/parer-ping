...
// TODO configurare correttamente
// @RunWith(Arquillian.class)

public class ControlliInvioOggettoAsincronoTest {
     ...
     * ArquillianUtils.createPingJar(ControlliInvioOggettoAsincrono.class).addPackages(true,
     * "org.xadisk", "it.eng.sacerasi", "it.eng.xformer", "com.amazonaws", "it.eng.parer.kettle",
     * "org.dom4j", "it.eng.integriam", "org.codehaus.jettison.json", "it.eng.parer.idpjaas");
     * pingJar.addAsResource(ArquillianUtils.class.getClassLoader().getResource("ws_handler.xml"),
     * "ws_handler.xml"); final EnterpriseArchive enterpriseArchive =
     * ArquillianUtils.createEnterpriseArchive(
     * ControlliInvioOggettoAsincronoTest.class.getSimpleName(), pingJar,
     * ArquillianUtils.createPaginatorJar(), ArquillianUtils.createSacerLogJar(),
     * ArquillianUtils.createJbossTimerJar()); ArquillianUtils.saveArchiveTo(enterpriseArchive,
     * "debug.ear"); return enterpriseArchive; }
     */
