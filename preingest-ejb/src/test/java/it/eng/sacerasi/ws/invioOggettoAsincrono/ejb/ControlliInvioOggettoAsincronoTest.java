...
public class ControlliInvioOggettoAsincronoTest {
     ...
     * "org.codehaus.jettison.json", "it.eng.parer.idpjaas");
     * pingJar.addAsResource(ArquillianUtils.class.getClassLoader().getResource("ws_handler.xml"), "ws_handler.xml");
     * final EnterpriseArchive enterpriseArchive = ArquillianUtils.createEnterpriseArchive(
     * ControlliInvioOggettoAsincronoTest.class.getSimpleName(), pingJar, ArquillianUtils.createPaginatorJar(),
     * ArquillianUtils.createSacerLogJar(), ArquillianUtils.createJbossTimerJar());
     * ArquillianUtils.saveArchiveTo(enterpriseArchive, "debug.ear"); return enterpriseArchive; }
     */
