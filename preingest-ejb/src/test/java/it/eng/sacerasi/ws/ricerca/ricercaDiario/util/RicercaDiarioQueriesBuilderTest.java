...
public class RicercaDiarioQueriesBuilderTest {

    @Test
    public void buildQueryConClausolaIN() {
        RicercaDiarioExt ricercaDiarioExt = new RicercaDiarioExt();
        ricercaDiarioExt.setRicercaDiarioInput(new RicercaDiarioInput("AMBIENTE", "VERSATORE", Constants.STUDIO_DICOM,
                "KEY OBJECT", 0L, "STATO OBJECT", true, 1, 1, "", "<xml></xml>", "<xml></xml>"));
        ...
        DatoSpecOrderConNomeColonna datoSpecOrderConNomeColonna = new DatoSpecOrderConNomeColonna(orderType,
                "COL_NAME_ORDER");
        ...
        DatoSpecFiltroConNomeColonna datoSpecifico = new DatoSpecFiltroConNomeColonna(filtroType, "COL_IN_TEST");
