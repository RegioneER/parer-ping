...
public class PigSessioneIngest implements Serializable {
    ...
    public PigStatoSessioneIngest addPigStatoSessioneIngest(
	    PigStatoSessioneIngest pigStatoSessioneIngest) {
    ...
    public PigStatoSessioneIngest removePigStatoSessioneIngest(
	    PigStatoSessioneIngest pigStatoSessioneIngest) {
    ...
    public PigXmlSessioneIngest removePigXmlSessioneIngest(
	    PigXmlSessioneIngest pigXmlSessioneIngest) {
    ...
    public void setPigXmlAnnulSessioneIngests(
	    List<PigXmlAnnulSessioneIngest> pigXmlAnnulSessioneIngests) {
	this.pigXmlAnnulSessioneIngests = pigXmlAnnulSessioneIngests;
    }

    public PigXmlAnnulSessioneIngest addPigXmlAnnulSessioneIngest(
