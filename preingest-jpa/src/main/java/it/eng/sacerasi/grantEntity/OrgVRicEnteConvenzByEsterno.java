...
public class OrgVRicEnteConvenzByEsterno implements Serializable {
    ...
    public OrgVRicEnteConvenzByEsterno(BigDecimal idEnteConvenz, String nmEnteConvenz,
	    BigDecimal idCategEnte, BigDecimal idAmbitoTerrit, Date dtCessazione, Date dtIniVal,
	    String flRecesso, BigDecimal enteAttivo, BigDecimal idAmbienteEnteConvenz,
	    Date dtDecAccordo, Date dtScadAccordo, String flInCorsoConvenz, String flNonConvenz,
	    String tiEnteConvenz, BigDecimal idEnteConserv, BigDecimal idEnteGestore,
    ...
    public OrgVRicEnteConvenzByEsterno(BigDecimal idEnteConvenz, String nmEnteConvenz,
	    ...
	    BigDecimal enteAttivo, String flRecesso, Date dtScadAccordo) {
	this.orgVRicEnteConvenzByEsternoId = new OrgVRicEnteConvenzByEsternoId();
	this.orgVRicEnteConvenzByEsternoId.setIdEnteConvenz(idEnteConvenz);
	this.nmEnteConvenz = nmEnteConvenz;
	this.idCategEnte = idCategEnte;
    ...
    public void setOrgVRicEnteConvenzByEsternoId(
	    OrgVRicEnteConvenzByEsternoId orgVRicEnteConvenzByEsternoId) {
