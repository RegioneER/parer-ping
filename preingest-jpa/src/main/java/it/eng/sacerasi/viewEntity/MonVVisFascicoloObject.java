...
/**
 * The persistent class for the MON_V_VIS_FASCICOLO_OBJECT database table.
 *
 */
@Entity
@Table(name = "MON_V_VIS_FASCICOLO_OBJECT")
public class MonVVisFascicoloObject implements Serializable {
