...
/**
 * The persistent class for the MON_V_VIS_OBJ_NON_VERS database table.
 */
@Entity
@Table(name = "MON_V_VIS_OBJ_NON_VERS")
public class MonVVisObjNonVers implements Serializable {
    ...
    private BigDecimal idObjectNonVers;
