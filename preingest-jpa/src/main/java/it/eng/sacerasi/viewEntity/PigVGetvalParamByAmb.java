...
@NamedQuery(name = "PigVGetvalParamByAmb.findAll", query = "SELECT p FROM PigVGetvalParamByAmb p")
public class PigVGetvalParamByAmb implements Serializable {
