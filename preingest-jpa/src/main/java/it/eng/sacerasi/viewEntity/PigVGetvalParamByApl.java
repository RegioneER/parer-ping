...
/**
 * The persistent class for the PIG_V_GETVAL_PARAM_BY_APL database table.
 *
 */
@Entity
@Table(name = "PIG_V_GETVAL_PARAM_BY_APL")
@NamedQuery(name = "PigVGetvalParamByApl.findAll", query = "SELECT p FROM PigVGetvalParamByApl p")
public class PigVGetvalParamByApl implements Serializable {
