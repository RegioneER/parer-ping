...
public class PigVRicVers implements Serializable {
    ...
    public PigVRicVers(BigDecimal idAmbienteVers, String nmAmbienteVers, BigDecimal idVers,
	    String nmVers, String dsListaDichStrutSacer, String nmAmbienteEnteConvenz,
	    String nmEnteConvenz, String nmTipoVersatore) {
