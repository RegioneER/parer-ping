...
public class UsrVAbilStrutSacerXping implements Serializable {
    ...
    public UsrVAbilStrutSacerXping(BigDecimal idUserIam, String type, BigDecimal id,
	    String nmCampo) {
    ...
    public UsrVAbilStrutSacerXping(BigDecimal idOrganizIam, String type,
    ...
    public UsrVAbilStrutSacerXping(BigDecimal idAmbiente, String nmAmbiente, BigDecimal idEnte,
	    String nmEnte, BigDecimal idStrut, String nmStrut) {
