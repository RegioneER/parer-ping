 ...
 * @author Sloth
 *
 *         Bean per la tabella Iam_Organiz_Da_Replic
 *
 */
public class IamOrganizDaReplicTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Iam_Organiz_Da_Replic /**/";
    public static final String TABLE_NAME = "Iam_Organiz_Da_Replic";
	...
	map.put(COL_TI_STATO_REPLIC,
		new ColumnDescriptor(COL_TI_STATO_REPLIC, Types.VARCHAR, 30, false));
