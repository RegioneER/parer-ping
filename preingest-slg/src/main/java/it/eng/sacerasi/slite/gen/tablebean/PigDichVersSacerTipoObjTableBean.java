...
/**
 * TableBean per la tabella Pig_Dich_Vers_Sacer_Tipo_Obj
 *
 */
public class PigDichVersSacerTipoObjTableBean extends AbstractBaseTable<PigDichVersSacerTipoObjRowBean> {
