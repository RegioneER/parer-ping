...
/**
 * RowBean per la tabella Pig_Log_Job
 *
 */
public class PigLogJobRowBean extends BaseRow implements JEEBaseRowInterface {
	...
	PigLogJob entity = (PigLogJob) obj;
    ...
    @Override
    public PigLogJob rowBeanToEntity() {
	PigLogJob entity = new PigLogJob();
