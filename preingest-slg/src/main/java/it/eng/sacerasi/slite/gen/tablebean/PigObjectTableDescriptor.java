...
public class PigObjectTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_FL_VERS_SACER_DA_RECUP, new ColumnDescriptor(COL_FL_VERS_SACER_DA_RECUP, Types.VARCHAR, 1, false));
        ...
        map.put(COL_NI_UNITA_DOC_ATTESE, new ColumnDescriptor(COL_NI_UNITA_DOC_ATTESE, Types.DECIMAL, 22, false));
        map.put(COL_NI_TOT_OBJECT_TRASF, new ColumnDescriptor(COL_NI_TOT_OBJECT_TRASF, Types.DECIMAL, 22, false));
        map.put(COL_ID_OBJECT_PADRE, new ColumnDescriptor(COL_ID_OBJECT_PADRE, Types.DECIMAL, 22, false));
        ...
        map.put(COL_CD_VERSIONE_TRASF, new ColumnDescriptor(COL_CD_VERSIONE_TRASF, Types.VARCHAR, 100, false));
        map.put(COL_CD_VERS_GEN, new ColumnDescriptor(COL_CD_VERS_GEN, Types.VARCHAR, 100, false));
        map.put(COL_FL_RICH_ANNUL_TIMEOUT, new ColumnDescriptor(COL_FL_RICH_ANNUL_TIMEOUT, Types.VARCHAR, 1, false));
    }
