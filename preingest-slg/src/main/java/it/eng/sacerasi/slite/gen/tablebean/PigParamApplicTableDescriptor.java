...
public class PigParamApplicTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_FL_APPART_VERS, new ColumnDescriptor(COL_FL_APPART_VERS, Types.VARCHAR, 1, false));
        map.put(COL_FL_APPART_TIPO_OGGETTO, new ColumnDescriptor(COL_FL_APPART_TIPO_OGGETTO, Types.VARCHAR, 1, false));
