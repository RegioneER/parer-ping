 ...
 * @author Sloth
 *
 *         Bean per la tabella Pig_Sessione_Ingest
 *
 */
public class PigSessioneIngestTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Pig_Sessione_Ingest /**/";
    public static final String TABLE_NAME = "Pig_Sessione_Ingest";
    ...
    public static final String COL_FL_FILE_CIFRATO = "fl_file_cifrato";
    ...
    public static final String COL_FL_SES_ERR_VERIF = "fl_ses_err_verif";
    public static final String COL_FL_SES_ERR_NON_RISOLUB = "fl_ses_err_non_risolub";
    ...
    static {
        ...
        map.put(COL_NM_TIPO_OBJECT, new ColumnDescriptor(COL_NM_TIPO_OBJECT, Types.VARCHAR, 100, false));
        map.put(COL_FL_FILE_CIFRATO, new ColumnDescriptor(COL_FL_FILE_CIFRATO, Types.VARCHAR, 1, false));
        ...
        map.put(COL_DL_MOTIVO_FORZA_ACCETTAZIONE,
                new ColumnDescriptor(COL_DL_MOTIVO_FORZA_ACCETTAZIONE, Types.VARCHAR, 1024, false));
        ...
        map.put(COL_NI_UNITA_DOC_DA_VERS, new ColumnDescriptor(COL_NI_UNITA_DOC_DA_VERS, Types.DECIMAL, 22, false));
        ...
        map.put(COL_DL_MOTIVO_CHIUSO_WARNING,
                new ColumnDescriptor(COL_DL_MOTIVO_CHIUSO_WARNING, Types.VARCHAR, 1024, false));
        map.put(COL_NI_UNITA_DOC_VERS_OK, new ColumnDescriptor(COL_NI_UNITA_DOC_VERS_OK, Types.DECIMAL, 22, false));
        map.put(COL_NI_UNITA_DOC_VERS_ERR, new ColumnDescriptor(COL_NI_UNITA_DOC_VERS_ERR, Types.DECIMAL, 22, false));
        map.put(COL_FL_FORZA_WARNING, new ColumnDescriptor(COL_FL_FORZA_WARNING, Types.VARCHAR, 1, false));
        map.put(COL_FL_SES_ERR_VERIF, new ColumnDescriptor(COL_FL_SES_ERR_VERIF, Types.VARCHAR, 1, false));
        map.put(COL_FL_SES_ERR_NON_RISOLUB, new ColumnDescriptor(COL_FL_SES_ERR_NON_RISOLUB, Types.VARCHAR, 1, false));
        map.put(COL_NI_UNITA_DOC_VERS_TIMEOUT,
                new ColumnDescriptor(COL_NI_UNITA_DOC_VERS_TIMEOUT, Types.DECIMAL, 22, false));
        map.put(COL_TI_STATO_VERIFICA_HASH, new ColumnDescriptor(COL_TI_STATO_VERIFICA_HASH, Types.VARCHAR, 20, false));
    }
