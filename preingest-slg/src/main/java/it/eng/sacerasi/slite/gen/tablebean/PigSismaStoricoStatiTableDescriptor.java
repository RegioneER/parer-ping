 ...
 *
 */
public class PigSismaStoricoStatiTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Pig_Sisma_Storico_Stati /**/";
    public static final String TABLE_NAME = "Pig_Sisma_Storico_Stati";
    public static final String COL_ID_STATO = "id_stato";
    public static final String COL_ID_SISMA = "id_sisma";
