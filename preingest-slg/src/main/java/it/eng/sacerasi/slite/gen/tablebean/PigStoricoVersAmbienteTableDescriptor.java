 ...
 * @author Sloth
 *
 *         Bean per la tabella Pig_Storico_Vers_Ambiente
 *
 */
public class PigStoricoVersAmbienteTableDescriptor extends TableDescriptor {

    /*
     * @Generated( value = "it.eg.dbtool.db.oracle.beangen.Oracle4JPAClientBeanGen$TableBeanWriter",
     * comments = "This class was generated by OraTool", date = "Thursday, 6 June 2019 10:48" )
     */

    public static final String SELECT = "Select * from Pig_Storico_Vers_Ambiente /**/";
    public static final String TABLE_NAME = "Pig_Storico_Vers_Ambiente";
    public static final String COL_ID_STORICO_VERS_AMBIENTE = "id_storico_vers_ambiente";
