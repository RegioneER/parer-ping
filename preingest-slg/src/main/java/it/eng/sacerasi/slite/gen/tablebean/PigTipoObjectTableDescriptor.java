...
public class PigTipoObjectTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DS_TIPO_OBJECT, new ColumnDescriptor(COL_DS_TIPO_OBJECT, Types.VARCHAR, 254, false));
        map.put(COL_TI_VERS_FILE, new ColumnDescriptor(COL_TI_VERS_FILE, Types.VARCHAR, 20, false));
        map.put(COL_TI_CALC_KEY_UNITA_DOC, new ColumnDescriptor(COL_TI_CALC_KEY_UNITA_DOC, Types.VARCHAR, 20, false));
        map.put(COL_FL_CONTR_HASH, new ColumnDescriptor(COL_FL_CONTR_HASH, Types.VARCHAR, 1, false));
        ...
        map.put(COL_DS_REG_EXP_CD_VERS, new ColumnDescriptor(COL_DS_REG_EXP_CD_VERS, Types.VARCHAR, 254, false));
    }
