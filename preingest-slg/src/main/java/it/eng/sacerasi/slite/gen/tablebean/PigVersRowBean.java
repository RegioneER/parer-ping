...
public class PigVersRowBean extends BaseRow implements JEEBaseRowInterface {
     ...
     * comments = "This class was generated by OraTool", date = "Tuesday, 30 April 2019 11:01" )
     */
	...
	if (entity.getDtIniValAppartEnteSiam() != null) {
	    this.setDtIniValAppartEnteSiam(
		    new Timestamp(entity.getDtIniValAppartEnteSiam().getTime()));
	}
	if (entity.getDtFineValAppartEnteSiam() != null) {
	    this.setDtFineValAppartEnteSiam(
		    new Timestamp(entity.getDtFineValAppartEnteSiam().getTime()));
	}
