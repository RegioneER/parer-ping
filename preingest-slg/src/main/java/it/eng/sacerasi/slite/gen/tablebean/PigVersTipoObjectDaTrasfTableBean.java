...
/**
 * TableBean per la tabella Pig_Vers_Tipo_Object_Da_Trasf
 *
 */
public class PigVersTipoObjectDaTrasfTableBean extends AbstractBaseTable<PigVersTipoObjectDaTrasfRowBean> {
