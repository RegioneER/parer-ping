...
/**
 * TableBean per la tabella Pig_Xml_Annul_Sessione_Ingest
 *
 */
public class PigXmlAnnulSessioneIngestTableBean extends AbstractBaseTable<PigXmlAnnulSessioneIngestRowBean> {
