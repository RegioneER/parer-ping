...
public class PigXsdDatiSpecTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_CD_VERSIONE_XSD, new ColumnDescriptor(COL_CD_VERSIONE_XSD, Types.VARCHAR, 100, false));
        map.put(COL_DT_VERSIONE_XSD, new ColumnDescriptor(COL_DT_VERSIONE_XSD, Types.TIMESTAMP, 7, false));
