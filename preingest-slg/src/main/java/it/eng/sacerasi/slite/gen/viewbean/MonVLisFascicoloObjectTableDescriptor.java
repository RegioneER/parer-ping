 ...
 *
 */
public class MonVLisFascicoloObjectTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Lis_Fascicolo_Object /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Fascicolo_Object";
    public static final String COL_ID_FASCIOLO_OBJECT = "id_fascicolo_object";
