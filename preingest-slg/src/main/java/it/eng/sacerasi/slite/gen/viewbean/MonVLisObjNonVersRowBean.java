...
public class MonVLisObjNonVersRowBean extends BaseRow implements JEEBaseRowInterface {
	...
	this.setIdVers(entity.getMonVLisObjNonVersId() == null ? null
		: entity.getMonVLisObjNonVersId().getIdVers());
	this.setNmVers(entity.getNmVers());
	this.setNmTipoObject(entity.getNmTipoObject());
	this.setCdKeyObject(entity.getMonVLisObjNonVersId() == null ? null
		: entity.getMonVLisObjNonVersId().getCdKeyObject());
