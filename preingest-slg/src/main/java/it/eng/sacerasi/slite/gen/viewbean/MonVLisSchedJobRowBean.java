 ...
 *
 */
public class MonVLisSchedJobRowBean extends BaseRow implements JEEBaseRowInterface {
    ...
    public static MonVLisSchedJobTableDescriptor TABLE_DESCRIPTOR = new MonVLisSchedJobTableDescriptor();
