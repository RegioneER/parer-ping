 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Lis_Ses_Errate
 *
 */
public class MonVLisSesErrateTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Lis_Ses_Errate /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Ses_Errate";
