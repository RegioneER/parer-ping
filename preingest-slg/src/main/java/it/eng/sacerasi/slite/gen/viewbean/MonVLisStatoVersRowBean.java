...
public class MonVLisStatoVersRowBean extends BaseRow implements JEEBaseRowInterface {
     ...
     * comments = "This class was generated by OraTool", date = "Thursday, 26 July 2018 13:00" )
     */
	...
	this.setIdUserIam(entity.getMonVLisStatoVersId() == null ? null
		: entity.getMonVLisStatoVersId().getIdUserIam());
	...
	this.setIdObject(entity.getMonVLisStatoVersId() == null ? null
		: entity.getMonVLisStatoVersId().getIdObject());
