 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Lis_Unita_Doc_Sessione
 *
 */
public class MonVLisUnitaDocSessioneTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Lis_Unita_Doc_Sessione /**/";
    public static final String TABLE_NAME = "Mon_V_Lis_Unita_Doc_Sessione";
	...
	map.put(COL_TI_STATO_UNITA_DOC_SESSIONE,
		new ColumnDescriptor(COL_TI_STATO_UNITA_DOC_SESSIONE, Types.VARCHAR, 25, true));
