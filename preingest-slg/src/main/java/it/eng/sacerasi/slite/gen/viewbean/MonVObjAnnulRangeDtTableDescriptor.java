 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Obj_Annul_Range_Dt
 *
 */
public class MonVObjAnnulRangeDtTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Obj_Annul_Range_Dt /**/";
    public static final String TABLE_NAME = "Mon_V_Obj_Annul_Range_Dt";
