...
/**
 * ViewBean per la vista Mon_V_Riep_Vers
 *
 */
...
/**
 * TableBean per la tabella Mon_V_Riep_Vers
 *
 */
public class MonVRiepVersTableBean extends AbstractBaseTable<MonVRiepVersRowBean> {
