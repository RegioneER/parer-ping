...
/**
 * ViewBean per la vista Mon_V_Vis_Last_Sched_Job
 *
 */
...
/**
 * TableBean per la tabella Mon_V_Vis_Last_Sched_Job
 *
 */
public class MonVVisLastSchedJobTableBean extends AbstractBaseTable<MonVVisLastSchedJobRowBean> {
