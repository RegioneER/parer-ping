 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Vis_Last_Sched_Job
 *
 */
public class MonVVisLastSchedJobTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Vis_Last_Sched_Job /**/";
    public static final String TABLE_NAME = "Mon_V_Vis_Last_Sched_Job";
