...
/**
 * ViewBean per la vista Mon_V_Vis_Ses_Errata
 *
 */
...
/**
 * TableBean per la tabella Mon_V_Vis_Ses_Errata
 *
 */
public class MonVVisSesErrataTableBean extends AbstractBaseTable<MonVVisSesErrataRowBean> {
