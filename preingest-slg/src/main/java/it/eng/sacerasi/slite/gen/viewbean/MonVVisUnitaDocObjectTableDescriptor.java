 ...
 *
 */
public class MonVVisUnitaDocObjectTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Vis_Unita_Doc_Object /**/";
    public static final String TABLE_NAME = "Mon_V_Vis_Unita_Doc_Object";
    ...
    public static final String COL_BL_XML_INDICE_SACER = "bl_xml_indice_sacer";
	...
	map.put(COL_ID_UNITA_DOC_OBJECT,
		new ColumnDescriptor(COL_ID_UNITA_DOC_OBJECT, Types.DECIMAL, 22, true));
	...
	map.put(COL_BL_XML_INDICE_SACER,
		new ColumnDescriptor(COL_BL_XML_INDICE_SACER, Types.CLOB, 4000, true));
