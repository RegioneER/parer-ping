...
public class MonVVisUnitaDocObjectTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_DS_INFO_OBJECT, new ColumnDescriptor(COL_DS_INFO_OBJECT, Types.VARCHAR, 163, true));
        ...
        map.put(COL_BL_XML_INDICE_SACER, new ColumnDescriptor(COL_BL_XML_INDICE_SACER, Types.CLOB, 4000, true));
