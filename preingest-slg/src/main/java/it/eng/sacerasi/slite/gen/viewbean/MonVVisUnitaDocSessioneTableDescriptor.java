 ...
 * @author Sloth
 *
 *         Bean per la tabella Mon_V_Vis_Unita_Doc_Sessione
 *
 */
public class MonVVisUnitaDocSessioneTableDescriptor extends TableDescriptor {
    ...
    public static final String SELECT = "Select * from Mon_V_Vis_Unita_Doc_Sessione /**/";
    public static final String TABLE_NAME = "Mon_V_Vis_Unita_Doc_Sessione";
