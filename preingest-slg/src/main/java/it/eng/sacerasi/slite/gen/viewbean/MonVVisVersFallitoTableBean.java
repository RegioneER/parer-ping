...
/**
 * ViewBean per la vista Mon_V_Vis_Vers_Fallito
 *
 */
...
/**
 * TableBean per la tabella Mon_V_Vis_Vers_Fallito
 *
 */
public class MonVVisVersFallitoTableBean extends AbstractBaseTable<MonVVisVersFallitoRowBean> {
