...
public class PigVRicVersTableDescriptor extends TableDescriptor {
    ...
    static {
        ...
        map.put(COL_NM_ORGANIZ_IAM_ENTE, new ColumnDescriptor(COL_NM_ORGANIZ_IAM_ENTE, Types.VARCHAR, 100, true));
        map.put(COL_NM_ORGANIZ_IAM_AMBIENTE,
                new ColumnDescriptor(COL_NM_ORGANIZ_IAM_AMBIENTE, Types.VARCHAR, 100, true));
        map.put(COL_NM_TIPO_VERSATORE, new ColumnDescriptor(COL_NM_TIPO_VERSATORE, Types.VARCHAR, 100, true));
    }
