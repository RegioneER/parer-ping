...
import it.eng.sacerasi.ws.rest.ejb.ControlliRestWS.TipiWSPerControlli;
...
public class AppInfosSrvlt extends HttpServlet {
    ...
    private boolean isUserAuthenticated(String authString, String ipAddr) {
        ...
        // check credentials
        RispostaControlli rs = myControlliWs.checkCredenziali(loginName, pwd, ipAddr, TipiWSPerControlli.WS_REST);
