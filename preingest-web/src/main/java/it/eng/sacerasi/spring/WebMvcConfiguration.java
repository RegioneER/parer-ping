 ...
 */
@EnableWebMvc
@ComponentScan(basePackages = { "it.eng.sacerasi.web", "it.eng.sacerasi.web.rest.controller", "it.eng.sacerasi.ws",
        "it.eng.sacerasi.spring", "it.eng.sacerasi.web.action", "it.eng.sacerasi.slite.gen.action", "it.eng.spagoCore",
        "it.eng.spagoLite" })
@Configuration
