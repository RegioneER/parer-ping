...
public class GestioneJobAction extends GestioneJobAbstractAction {
    ...
    public void initOnClick() throws EMFError {
        // FIXME: sul csv, a differenza di sacer e iam la gestione dei job non è agganciata all'initOnClick
        gestioneJob();
    }
    ...
    public void gestioneJob() throws EMFError {
        ...
        StatoJob preparaXml = new StatoJob(Constants.NomiJob.PREPARA_XML.name(),
                ...
                getForm().getPreparaXMLSACER().getDt_prossima_attivazione(), getForm().getPreparaXMLSACER().getAttivo(),
                getForm().getPreparaXMLSACER().getDt_reg_log_job_ini(), dataAttivazioneJob);

        gestisciStatoJob(preparaXml);

        // </editor-fold>
        // <editor-fold defaultstate="collapsed" desc="UI Gestione job per Producer coda versamento">
        ...
        // </editor-fold>
        // <editor-fold defaultstate="collapsed" desc="UI Gestione job per Recupera versamenti in error">
        ...
        StatoJob recuperaVersamentiErrati = new StatoJob(Constants.NomiJob.RECUPERA_VERS_ERR.name(),
                ...
                getForm().getRecuperaVersErr().getDt_prossima_attivazione(), getForm().getRecuperaVersErr().getAttivo(),
        ...
        StatoJob recuperoSacer = new StatoJob(Constants.NomiJob.RECUPERO_SACER.name(),
                ...
                getForm().getRecuperoSACER().getDt_prossima_attivazione(), getForm().getRecuperoSACER().getAttivo(),
                getForm().getRecuperoSACER().getDt_reg_log_job_ini(), dataAttivazioneJob);

        gestisciStatoJob(recuperoSacer);

        // </editor-fold>
        // <editor-fold defaultstate="collapsed" desc="UI Gestione job per Producer coda verifica hash">
        dataAttivazioneJob = getActivationDateJob(Constants.NomiJob.PRODUCER_CODA_VERIFICA_H.name());
        StatoJob producerCodaVerificaH = new StatoJob(Constants.NomiJob.PRODUCER_CODA_VERIFICA_H.name(),
        ...
        dataAttivazioneJob = getActivationDateJob(Constants.NomiJob.ALLINEAMENTO_ORGANIZZAZIONI.name());
        StatoJob allineamentoOrganizazzioni = new StatoJob(Constants.NomiJob.ALLINEAMENTO_ORGANIZZAZIONI.name(),
        ...
        // </editor-fold>
        // <editor-fold defaultstate="collapsed" desc="UI Gestione job per Invia oggetti generati a PING">
        dataAttivazioneJob = getActivationDateJob(Constants.NomiJob.INVIA_OGGETTI_GENERATI_A_PING.name());
        StatoJob inviaOggettiGenerati = new StatoJob(Constants.NomiJob.INVIA_OGGETTI_GENERATI_A_PING.name(),
                ...
                getForm().getInviaOggettiGeneratiAPing().getVt_reg_log_job_ini(), dataAttivazioneJob);

        gestisciStatoJob(inviaOggettiGenerati);
        // </editor-fold>
        // <editor-fold defaultstate="collapsed" desc="UI Gestione job per Invio strumenti urbanistici">
        // nextActivation = allineamentoOrganizzazioniTimer.getNextElaboration(nomeApplicazione);
        dataAttivazioneJob = getActivationDateJob(Constants.NomiJob.INVIO_STRUMENTI_URBANISTICI.name());
        StatoJob invioStrumentiUrbanistici = new StatoJob(Constants.NomiJob.INVIO_STRUMENTI_URBANISTICI.name(),
                getForm().getInvioSU().getFl_data_accurata(), getForm().getInvioSU().getStartInvioSU(),
                getForm().getInvioSU().getStartOnceInvioSU(), getForm().getInvioSU().getStopInvioSU(),
                getForm().getInvioSU().getDt_prossima_attivazione(), getForm().getInvioSU().getAttivo(),
                getForm().getInvioSU().getDt_reg_log_job_ini(), dataAttivazioneJob);
        ...
        StatoJob invioSisma = new StatoJob(Constants.NomiJob.INVIO_SISMA.name(),
                getForm().getInvioSisma().getFl_data_accurata(), getForm().getInvioSisma().getStartInvioSisma(),
                getForm().getInvioSisma().getStartOnceInvioSisma(), getForm().getInvioSisma().getStopInvioSisma(),
                getForm().getInvioSisma().getDt_prossima_attivazione(), getForm().getInvioSisma().getAttivo(),
    ...
    public void startOncePreparaXMLSACER() throws EMFError {
        esegui(Constants.NomiJob.PREPARA_XML.name(), "Prepara xml", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods end manage ProducerCodaVersamento schedulation">
    @Override
    public void startProducerCodaVersamento() throws EMFError {
        esegui(Constants.NomiJob.PRODUCER_CODA_VERS.name(), "Producer coda versamento", null, OPERAZIONE.START);
    }
    ...
    public void stopProducerCodaVersamento() throws EMFError {
        esegui(Constants.NomiJob.PRODUCER_CODA_VERS.name(), "Producer coda versamento", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods end manage RecuperoErroriCoda schedulation">
    @Override
    public void startRecuperaErroriCoda() throws EMFError {
        esegui(Constants.NomiJob.RECUPERA_ERRORI_IN_CODA.name(), "Recupero errori in coda", null, OPERAZIONE.START);
    }
    ...
    public void stopRecuperaErroriCoda() throws EMFError {
        esegui(Constants.NomiJob.RECUPERA_ERRORI_IN_CODA.name(), "Recupero errori in coda", null, OPERAZIONE.STOP);
    }
    // </editor-fold>
    ...
    public void startOnceRecuperoSACER() throws EMFError {
        esegui(Constants.NomiJob.RECUPERO_SACER.name(), "Recupero sacer", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods end manage RecuperaVersamentoErrato schedulation">
    @Override
    public void startRecuperaVersErr() throws EMFError {
        esegui(Constants.NomiJob.RECUPERA_VERS_ERR.name(), "Recupera vers err", null, OPERAZIONE.START);
    }

    @Override
    public void startOnceRecuperaVersErr() throws EMFError {
        esegui(Constants.NomiJob.RECUPERA_VERS_ERR.name(), "Recupera vers err", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }

    @Override
    public void stopRecuperaVersErr() throws EMFError {
        esegui(Constants.NomiJob.RECUPERA_VERS_ERR.name(), "Recupera vers err", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods end manage ProducerCodaVerifica schedulation">
    @Override
    public void startProducerCodaVerificaH() throws EMFError {
        esegui(Constants.NomiJob.PRODUCER_CODA_VERIFICA_H.name(), "Producer Coda Verifica Hash", null,
                OPERAZIONE.START);
    }
    ...
    public void stopProducerCodaVerificaH() throws EMFError {
        esegui(Constants.NomiJob.PRODUCER_CODA_VERIFICA_H.name(), "Producer Coda Verifica Hash", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methods end manage AllineamentoOrganizzazioni schedulation">
    @Override
    public void startAllineamentoOrganizzazioni() throws EMFError {
        esegui(Constants.NomiJob.ALLINEAMENTO_ORGANIZZAZIONI.name(), "Allineamento organizzazioni", null,
                OPERAZIONE.START);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods end manage Inizializzazione Log schedulation">
    @Override
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods end manage Allineamento Log schedulation">
    @Override
    ...
    public void startEseguiTrasformazione() throws EMFError {
        esegui(Constants.NomiJob.ESEGUI_TRASFORMAZIONE.name(), "Esegui trasformazione", null, OPERAZIONE.START);
    }
    ...
    public void stopEseguiTrasformazione() throws EMFError {
        esegui(Constants.NomiJob.ESEGUI_TRASFORMAZIONE.name(), "Esegui trasformazione", null, OPERAZIONE.STOP);
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Methodi per gestire Invia oggetti generati a PING">
    @Override
    public void startInviaOggettiGeneratiAPing() throws EMFError {
        esegui(Constants.NomiJob.INVIA_OGGETTI_GENERATI_A_PING.name(), "Invia oggetti generati a PING", null,
                OPERAZIONE.START);
    }
    ...
    // <editor-fold defaultstate="collapsed" desc="Methods end manage Invio strumenti urbanistici schedulation">
    @Override
    public void startInvioSU() throws EMFError {
        esegui(Constants.NomiJob.INVIO_STRUMENTI_URBANISTICI.name(), "Invio strumenti urbanistici", null,
                OPERAZIONE.START);
    }
    ...
    public void startOnceInvioSisma() throws EMFError {
        esegui(Constants.NomiJob.INVIO_SISMA.name(), "Invio sisma", null, OPERAZIONE.ESECUZIONE_SINGOLA);
    }
    ...
    public void gestioneJobRicercaPage() throws EMFError {
        ...
        abilitaDisabilitaBottoniJob(!gestioneJobEjb.isPigDecJobFotoEmpty() && gestioneJobEjb.areAllJobsDisattivati(),
