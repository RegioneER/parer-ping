...
public class MultipartFileUploadSismaToS3Servlet extends HttpServlet {
    ...
    private static final Logger log = LoggerFactory.getLogger(MultipartFileUploadSismaToS3Servlet.class);
                ...
                while (iter.hasNext()) {
                    ...
                    if (item.isFormField()) {
                        ...
                        if ("name".equals(nomeCampo)) {
                            ...
                            /*
                             * Questo nuovo parametro lo memorizza per creare poi il tipo documento in sostituzione di
                             * quello che era stato eventualmente fleggato dall'Agenzia con KO
                             */
                        } else if ("tiVerificaAgenzia".equals(nomeCampo)) {
                            // Se dal web fiene passato null in java viene ricevuto come "false" quindi in questo caso
