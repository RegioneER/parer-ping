...
public class MultipartFileUploadSismaToS3Servlet extends HttpServlet {
    ...
    private static final String RESP_ERROR_SQL = "{\"jsonrpc\" : \"2.0\", \"error\" : {\"code\": 501, \"message\": \"Documento sisma modificato in un'altra sessione utente.\"}, \"id\" : \"id\"}";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (isMultipart) {
            ...
            try {
                ...
                // MEV 34787 - l'errore è molto generico ma dalla libreria non viene restituito il
                // codice di errore
                // fornito da sql
