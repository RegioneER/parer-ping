 ...
 * @author Iacolucci_M
 */
public class S3UploadSessionSU {

    private static final Logger log = LoggerFactory.getLogger(S3UploadSessionSU.class);
    ...
    public S3UploadSessionSU(SalvataggioBackendHelper salvataggioBackendHelper, ObjectStorageBackend config,
            String keyName) {
    ...
    public S3UploadSessionSU(SalvataggioBackendHelper salvataggioBackendHelper, BigDecimal idStrumentiUrbanistici,
