...
public class MonitoraggioValidator extends TypeValidator {
    ...
    public void validaSceltaPeriodoGiornoVersamento(String periodo, Date data) {
        if (periodo != null && data != null) {
            getMessageBox().addMessage(
                    new Message(MessageLevel.ERR, "Filtri periodo e giorno versamento entrambi valorizzati!"));
    ...
    public void validaSceltaPeriodoGiornoVersamento(String periodo, Date giorno_vers_da, BigDecimal ore_vers_da,
        ...
        if (periodo != null && (giorno_vers_da != null || ore_vers_da != null || minuti_vers_da != null
            ...
            getMessageBox().addMessage(
                    new Message(MessageLevel.ERR, "Campi periodo e giorno versamento entrambi valorizzati!"));
    ...
    public void validaSceltaCodiceGruppoErrori(String codiceErrore, String gruppoErrori) {
        if (codiceErrore != null && gruppoErrori != null) {
            getMessageBox().addMessage(
                    new Message(MessageLevel.ERR, "Filtri codice errore e gruppo errori entrambi valorizzati!"));
        }
    }

    /**
     * Controllo di coerenza tra i flag "Verificato" e "Non risolubile" e, in caso vada considerato, con lo stato
     * NON_RISOLTO
     *
     * @param verificato
     *            flag 1/0 (true/false)
     ...
     *            true/false
     */
    public void validaFlagVerificatoNonRisolubile(String verificato, String nonRisolubile, Boolean nonRisolto) {
