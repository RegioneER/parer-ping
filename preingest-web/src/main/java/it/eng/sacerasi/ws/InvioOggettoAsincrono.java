...
public class InvioOggettoAsincrono {
    ...
    @HandlerChain(file = "/ws_handler.xml")
    public InvioOggettoAsincronoRisposta invioOggettoAsincrono(@WebParam(name = "nmAmbiente") String nmAmbiente,
            ...
            @WebParam(name = "cdVersioneXml") String cdVersioneXml, @WebParam(name = "xml") String xml) {
        ...
        try {
            ...
            risposta = ejbRef.invioOggettoAsincrono(username, nmAmbiente, nmVersatore, cdKeyObject, nmTipoObject,
                    flFileCifrato, flForzaWarning, flForzaAccettazione, dlMotivazione, cdVersioneXml, xml, null);
    ...
    public InvioOggettoAsincronoEstesoRisposta invioOggettoAsincronoEsteso(
            ...
            @WebParam(name = "cdKeyObject") String cdKeyObject, @WebParam(name = "dsObject") String dsObject,
            @WebParam(name = "nmTipoObject") String nmTipoObject,
            @WebParam(name = "flFileCifrato") boolean flFileCifrato,
            @WebParam(name = "flForzaWarning") boolean flForzaWarning,
            @WebParam(name = "flForzaAccettazione") boolean flForzaAccettazione,
        ...
        try {
            wsHelper.checkAuthorizations(nmAmbiente, nmVersatore, username, servizioWeb);
            // FIXME il parametro priorità per ora non è passato, vedere se possibile cambiare la signature del
            // webservice
            risposta = ejbRef.invioOggettoAsincronoEsteso(username, nmAmbiente, nmVersatore, cdKeyObject, dsObject,
                    nmTipoObject, flFileCifrato, flForzaWarning, flForzaAccettazione, dlMotivazione, cdVersioneXml, xml,
