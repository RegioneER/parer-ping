...
import it.eng.sacerasi.ws.notificaInAttesaPrelievo.ejb.NotificaInAttesaPrelievoEjb;
...
@WebService(serviceName = "NotificaInAttesaPrelievo")
@HandlerChain(file = "/ws_handler.xml")
@SchemaValidation
public class NotificaInAttesaPrelievo {
    @Resource
    private WebServiceContext wsCtx;
    @EJB
    private WsHelper wsHelper;
    @EJB
    private NotificaInAttesaPrelievoEjb ejbRef;

    @WebMethod(operationName = "notificaInAttesaPrelievo")
    public NotificaInAttesaPrelievoRisposta notificaInAttesaPrelievo(@WebParam(name = "nmAmbiente") String nmAmbiente,
        ...
        NotificaInAttesaPrelievoRisposta risposta = null;
        try {
            wsHelper.checkAuthorizations(nmAmbiente, nmVersatore, username, servizioWeb);
            risposta = ejbRef.notificaInAttesaPrelievo(nmAmbiente, nmVersatore, cdKeyObject);
