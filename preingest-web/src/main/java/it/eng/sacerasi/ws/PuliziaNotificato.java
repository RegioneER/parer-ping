...
import it.eng.sacerasi.ws.puliziaNotificato.ejb.PuliziaNotificatoEjb;
...
@WebService(serviceName = "PuliziaNotificato")
@HandlerChain(file = "/ws_handler.xml")
@SchemaValidation
public class PuliziaNotificato {
    @Resource
    private WebServiceContext wsCtx;
    @EJB
    private WsHelper wsHelper;
    @EJB
    private PuliziaNotificatoEjb ejbRef;

    @WebMethod(operationName = "puliziaNotificato")
    public PuliziaNotificatoRisposta puliziaNotificato(@WebParam(name = "nmAmbiente") String nmAmbiente,
        ...
        PuliziaNotificatoRisposta risposta = null;
        try {
            wsHelper.checkAuthorizations(nmAmbiente, nmVersatore, username, servizioWeb);
            risposta = ejbRef.puliziaNotificato(nmAmbiente, nmVersatore, cdKeyObject);
