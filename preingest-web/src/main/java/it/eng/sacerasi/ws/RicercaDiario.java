...
public class RicercaDiario {
    ...
    public RicercaDiarioRisposta ricercaDiario(@WebParam(name = "nmAmbiente") String nmAmbiente,
            @WebParam(name = "nmVersatore") String nmVersatore, @WebParam(name = "nmTipoObject") String nmTipoObject,
            @WebParam(name = "cdKeyObject") String cdKeyObject, @WebParam(name = "idSessione") Long idSessione,
        ...
        try {
            ...
            risposta = ejbRef.ricercaDiario(nmAmbiente, nmVersatore, nmTipoObject, cdKeyObject, idSessione,
                    tiStatoObject, flTutteSessioni, niRecordInizio, niRecordResultSet, xmlDatiSpecOutput,
