...
import it.eng.sacerasi.ws.ricerca.ricercaRecuperati.ejb.RicercaRecuperatiEjb;
...
@WebService(serviceName = "RicercaRecuperati")
@HandlerChain(file = "/ws_handler.xml")
@SchemaValidation
public class RicercaRecuperati {
    @Resource
    private WebServiceContext wsCtx;
    @EJB
    private WsHelper wsHelper;
    @EJB
    private RicercaRecuperatiEjb ejbRef;

    @WebMethod(operationName = "ricercaRecuperati")
    public RicercaRecuperatiRisposta ricercaRecuperati(@WebParam(name = "nmAmbiente") String nmAmbiente,
