...
import it.eng.sacerasi.ws.richiestaRestituzioneOggetto.ejb.RichiestaRestituzioneOggettoEjb;
...
@WebService(serviceName = "RichiestaRestituzioneOggetto")
@HandlerChain(file = "/ws_handler.xml")
@SchemaValidation
public class RichiestaRestituzioneOggetto {
    @Resource
    private WebServiceContext wsCtx;
    @EJB
    private WsHelper wsHelper;
    @EJB
    private RichiestaRestituzioneOggettoEjb ejbRef;
    ...
    public RichiestaRestituzioneOggettoRisposta richiestaRestituzioneOggetto(
            ...
            @WebParam(name = "cdPassword") String cdPassword, @WebParam(name = "cdKeyObject") String cdKeyObject) {
