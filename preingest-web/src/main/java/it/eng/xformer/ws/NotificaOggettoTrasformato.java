...
/**
 * WS di notifica oggetto trasformato. Scopo di questo ws è aggiornare lo stato del
 * <em>PigObject</em> associato alla trasformazione.
 *
 * @author Cappelli_F
 * @author Snidero_L
 */
...
public class NotificaOggettoTrasformato {
    ...
    /**
     * Metodo invocato da <em>parer-kettle</em> al termine di una trasformazione. L'handler chain è
     * stato implementato in questo progetto (non nel framework) a causa delle sue specificità. In
     * questo caso non è necessario effettuare alcun controllo di sicurezza ulteriore rispetto a
     * quelli effettuati nell'handler chain associato.
     *
     * @param idOggetto    id dell'oggetto che ha subito la trasformazione.
     * @param numeroErrori numero degli eventuali errori della trasformazione.
     * @param report       parametro opzionale sia in caso di trasformazione eseguita con successo
