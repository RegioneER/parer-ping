...
<html>
    ...
    <body>
        <h1>Recupero dello status dell'applicazione sulla singola istanza</h1>
        <h2>Viene chiamata la servlet/ws <b>StatusMonitorHost</b></h2>
        <form action="StatusMonitorHost" method="post" >
            <div class="box">
