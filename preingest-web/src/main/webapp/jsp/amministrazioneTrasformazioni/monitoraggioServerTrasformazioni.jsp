        ...
        <sl:content>
            ...
            <sl:contentTitle title="<%=TrasformazioniForm.MonitoraggioServerTrasformazioniSection.DESCRIPTION%>"/>
             ...
             <slf:fieldSet borderHidden="false">
                ...
                <slf:lblField name="<%=TrasformazioniForm.MonitoraggioServerTrasformazioniDetail.ID_OBJ%>" colSpan="2"/><sl:newLine />
                <slf:lblField name="<%=TrasformazioniForm.MonitoraggioServerTrasformazioniDetail.CD_TRASF%>" colSpan="4"/><sl:newLine />
                <slf:lblField name="<%=TrasformazioniForm.MonitoraggioServerTrasformazioniDetail.DT_INIZIO_TRASF%>" colSpan="2"/><sl:newLine />
                <slf:lblField name="<%=TrasformazioniForm.MonitoraggioServerTrasformazioniDetail.DT_FINE_TRASF%>" colSpan="2"/><sl:newLine />
             </slf:fieldSet>
